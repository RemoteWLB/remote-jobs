# [Cloud Site Reliability Engineer (m/f/x) onsite or remote in Germany or Austria](https://www.remotewlb.com/apply/cloud-site-reliability-engineer-m-f-x-onsite-or-remote-in-germany-or-austria-108019)  
### Scalable GmbH  
#### `🌎 Remote,Wien, Austria`  
...
We embrace a DevOps culture where the development teams manage their own CI/CD pipelines and cloud infrastructure for their services themselves. Our Site Reliability Engineering Team focuses on a reusable and modular infrastructure to enable the development teams to deploy and operate services in the cloud productively and securely.

  * You will continuously improve our Cloud Foundation in AWS
  * You will be responsible for improving infrastructure and deployment automation using tools like Terraform, AWS Lambda and Python
  * You will develop custom tools and scripts to automate on AWS
  * You will mentor and enable our engineering teams to further foster our DevOps culture

###  **Qualifications**

  * Multiple Years of Experience with AWS and its services, especially VPC, IAM, ECS, Lambda, S3 and Organizations
  * Proficient with Infrastructure as Code, ideally Terraform
  * Working knowledge in at least one general purpose programming language, preferably Python
  ...
  * Proficiency in communicating concisely in an international English-speaking environment
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/cloud-site-reliability-engineer-m-f-x-onsite-or-remote-in-germany-or-austria-108019)

# [Senior Software Engineer, Camera Performance & Stability](https://www.remotewlb.com/apply/senior-software-engineer-camera-performance-stability)  
### Flock Safety  
#### `🌎 Tampere, Finland`  
...
Flock Safety is looking to add a Senior Software Engineer, Camera Performance & Stability to our rapidly growing Imaging Team within our Device Engineering organization. Flock Safety is continuously building more complex camera systems with multiple cameras and increased processing loads. In this role, you will strengthen our capability to optimize use cases and hardware utilization for enhanced performance and reduced power utilization. Our focus is to effectively balance image quality and power consumption for each specific configuration.

This position is on-site in Tampere, Finland.

## **The Skillset**

**We're looking for people with:**

  * Bachelors/Master of Science in Computer Engineering, Computer Science, Electrical Engineering, or related field with 5+ years experience
  * Familiarity with Qualcomm or Android performance debugging tools for performance and power tracing
  * Linux kernel and device drivers development experience (C++)
  * Ability to analyze the system performance and identify the bottlenecks in a complex camera system on power & performance
  * Ability to develop own performance and power debugging tools (Python, C++, Java/Kotlin)
  * Low-level firmware SW development experience (device drivers, MCUs, various protocols I2C, CSI, memory, etc.)
  * Familiarity with source control solutions such as (git/Github/Gerrit)
  * Familiarity with modern software development practices and tools (DevOps)
...
**The ideal candidate will have:**
  ...
  * Experience on the Qualcomm or Android camera pipelines (Chi, Camx)
  * Knowledge of automated performance and power measurement tool
  * Ability to develop by using test-driven development
...
**The First 30 Days**
  ...
  * Learn Flock products and their application within the lab
  * Meet with key stakeholders
  * Establish tailored environments and start contributing to the code
  * Conduct comprehensive power and performance analyses for the Flock camera system

**The First 60 Days**

  * Analyze Flock cameras’ power and performance on specific requirements
  * Deep dive into the camera pipeline on Flock cameras

**90 Days & Beyond**

  * After 90 days, you'll be fully proficient and self-assured in your role
  * Analyze the cameras’ processing pipeline and perform power and performance measurements
  * Working on Flock camera algorithms and optimizations
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-camera-performance-stability)

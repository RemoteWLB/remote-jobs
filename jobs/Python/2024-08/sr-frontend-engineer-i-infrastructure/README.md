# [Sr. Frontend Engineer I, Infrastructure](https://www.remotewlb.com/apply/sr-frontend-engineer-i-infrastructure)  
### Khan Academy  
#### `💰 $137,781 - $172,339 USD` `🌎 Mountain View, CA / Remote friendly (US + Canada Only)`  
...
Currently we are focused on providing equitable solutions to historically under-resourced communities of learners and teachers, and guided by our Engineering Principles. On the Infrastructure team, you’ll be supporting our product teams, and you might work on projects such as:

  * Building out new components in our open source, React-based, Wonder Blocks design system that’s used everywhere within our web and mobile products.
  * Overhauling how we handle CSS on our site, using a modern CSS-in-JS system, and utilizing our shared tokens from Wonder Blocks.
  * Improving the performance of our rendering on mobile devices, decreasing the amount of code shipped, and improving responsiveness.
  * Improving the accessibility of our reusable components and shared UI across our website.

We are a remote-first organization and we strive to build using technology that is best suited to solving problems for our learners. Currently, we build with JavaScript, React & React Native, Node.js, TypeScript, and we adopt new technologies like LLMs when they’ll help us better achieve our goals. At Khan Academy, one of our values is “Cultivate Learning Mindsets”, so for us, it’s important that we’re working with all of our engineers to help match the right opportunity to the right individual, in order to ensure every engineer is operating at their “learning edge”.
...
**WHAT YOU BRING**
  ...
  * 5+ years experience building world-class product experiences for an interactive web-app. In particular, you have built and maintained complex, stateful, frontend user interfaces that make good use of modern CSS and React.
  ...
  * Experience building accessible UI components that can be used by other engineers that follow industry standards (e.g. WCAG).
...
Candidates with strong experience using CSS and React. Also those with experience in improving web performance (especially for mobile users) and web accessibility.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/sr-frontend-engineer-i-infrastructure)

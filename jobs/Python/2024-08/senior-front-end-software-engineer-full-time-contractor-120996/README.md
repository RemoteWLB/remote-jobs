# [Senior Front-end Software Engineer (Full-Time Contractor)](https://www.remotewlb.com/apply/senior-front-end-software-engineer-full-time-contractor-120996)  
### Varsity Tutors  
#### `💰 Competitive Pay (USD)` `🌎 Remote - Costa Rica `  

**Description:**

We are looking for Senior Front-End Engineers (full-time contractors) based in South America to join the engineering team to help with our ongoing growth and expansion! Your focus would be on building frontend experiences in React. Familiarity with backend services & technologies is a plus, particularly in Ruby on Rails. We have a complete CI/CD software lifecycle and an evolving services-oriented-architecture hosted in AWS. We operate in a highly collaborative environment with Product and Design to build experiences that matter to our customers. At Varsity Tutors, engineers do not just write code, they actively participate in the conversation on what and how to build the systems and solutions that matter to our customers. If you love your customers as much as we do, we'd love to hear from you.
...
**Qualifications:**
  ...
  * Experience with with React and Ruby on Rails is strongly preferred.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-front-end-software-engineer-full-time-contractor-120996)

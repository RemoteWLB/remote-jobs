# [Frontend Software Engineer, Legal Ops](https://www.remotewlb.com/apply/frontend-software-engineer-legal-ops)  
### None  
#### `💰 $174,000/yr - $235,000/yr` `🌎 Remote-Canada`  
...
EvenUp's Legal Ops (LOPS) engineering team is seeking a frontend-focused Software Engineer to lead the development & enhancement of our tooling and workflows. In this role, you will play a critical part in delivering value to our customers and ensuring that personal injury victims receive the rightful compensation they deserve. This is an exciting opportunity for someone passionate about understanding user needs and addressing them directly with captivating user interfaces for AI-generated document creation. As part of our team, you'll drive future innovations that make a significant impact across the business.

 **What you'll do:**

  * Build and refine the frontend of our AI-driven platform to deliver an intuitive, responsive and user-friendly interface.
  ...
  * Implement robust, maintainable, well-tested and reusable code in a modern tech-stack including React, Typescript, and other technologies.

 **What we look for:**

  * 3-5+ years of experience in software development, with a special focus on modern frontend technologies like TypeScript and React.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/frontend-software-engineer-legal-ops)

# [Full Stack Engineer - Marketing Automation](https://www.remotewlb.com/apply/full-stack-engineer-marketing-automation)  
### StackAdapt  
#### `💰 Competitive salary + equity` `🌎 remote,Canada`  
...
* As an engineer, you are expected to take responsibility and ownership of projects from start to finish.
...
* Previous engineering experience working in marketing technology and CDP is required. 
* You must have knowledge of React and Javascript/Typescript
* Knowledge of Redux, Ruby on Rails and GraphQL is highly preferred. 
* Experience with implementing a client-facing project end-to-end, from design to delivery.
* Experience collaborating closely with product and design teams to design, implement and iterate on high impact end-to-end product experiences.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/full-stack-engineer-marketing-automation)

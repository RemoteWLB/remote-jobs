# [Machine Learning Engineer II](https://www.remotewlb.com/apply/machine-learning-engineer-ii-118315)  
### Spring Health  
#### `💰 $120,000 - $150,250` `🌎 Remote`  

We are looking for a Machine Learning Engineer to join our AI Foundations team. In this role you will build and enhance the models powering Spring Health’s precision mental health engine and develop the Spring AI platform. This is an opportunity to design and implement innovative data products that will positively impact the lives of our members as well as contribute to and move the science and practice of mental health forward.

**What you’ll be doing:**

  * Contribute to the development of algorithms and datasets that power a personalized member care journey and data products that enhance caregiver capabilities and outcomes.
  * Develop and bring to production data-centric product features like search and personalized recommendations.
  * Develop an AI Platform to support new data products across the company.
  * Build GenAI products to improve both member and provider experiences.
  * Monitor and continuously improve deployed models.

**What success looks like in this role:**

  * Improve recommender system models to match members with providers
  * Create new data products using GenerativeAI
...
**What we expect from you:**
  ...
  * Degree in a STEM, Economics, or related quantitative field, and at least 2 years of commercial experience in a ML engineer role, or a related role such as data/backend engineer with direct experience in data science products.
  * Proficient in Python and SQL, including standard modeling libraries such as Pytorch and Scikit-Learn.
  * Experience building data pipelines for models and analytics (eg. Airflow, Prefect, or similar).
  * Experience with deploying and managing model endpoints (eg. Sagemaker, Vertex AI, or similar).
  * Proficiency with GenAI workflows (eg. RAG, prompt-engineering).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/machine-learning-engineer-ii-118315)

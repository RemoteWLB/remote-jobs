# [Senior Software Engineer (Backend) - Fleet Management](https://www.remotewlb.com/apply/senior-software-engineer-backend-fleet-management)  
### EquipmentShare  
#### `💰 $Competitive base salary and market leading equity package (pre-IPO).` `🌎 Remote`  
...
We are looking for a **Senior Software Engineer** _(_ **backend** ) to help us continue to build the next evolution of our platform in a scalable, performant and customer-centric oriented architecture.

Our **main tech stack** includes : _AWS, Kubernetes, Python, Kafka, PostgreSQL, DynamoDB, Kinesis_

If you have **production scale** experience in a **different stack** ( _Go, Java, Scala, C#, etc_.) and are interested in moving to a new stack, we should chat.
...
You’ll be part of a **close knit** team of Engineers developing the **next generation** of our T3 Fleet application that **enables** end-users to track, monitor and manage the health of their connected vehicles and deployed assets.
...
Some of the things that **would be nice to have,** but **not required** :
  ...
  * Experience with streaming technologies. ( _AWS Kinesis, Kafka, etc._ )
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-backend-fleet-management)

# [Ingénieur Informatique Industrielle H/F](https://www.remotewlb.com/apply/ingenieur-informatique-industrielle-h-f-112080)  
### ASSYSTEM  
#### `🌎 Remote,Saint-Paul-lez-Durance, France`  
...
En tant **qu'Ingénieur (e) d'Étude en Informatique Industrielle** , vous jouez un rôle clé dans la définition et l'intégration des **systèmes de contrôle-commande** pour la machine ITER. Plus précisément, votre mission consiste à : :

  * **Réaliser des analyses techniques** l’automatisme et de la supervision pour le design du système central de contrôle-commande sécuritaire de la machine ITER,
  *  **Spécifier, concevoir et développer** des librairies logicielles, des maquettes de principe et des bancs d'essais, en respectant les procédures et choix techniques établis,
 ...
 **Vos atouts et les prérequis pour réussir**
  ...
  * Vous êtes issu(e) d’une **** formation **Bac +5 minimum** (école d’Ingénieur de préférence) avec une spécialisation en **informatique**.
  * Les profils **débutant** s sont acceptés.
  *  **Compétences informatiques** requises : Langages C, C++, Python, Bash dans les **environnements** Windows ou Linux.
  * Vous maitrisez **l'anglais** aussi bien à **l’oral** qu’à **l'écrit** car vous évoluez dans un environnement international.
  *  **Capacités rédactionnelles** , **autonomie** et **adaptabilité** sont essentielles pour réussir dans la mission.  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/ingenieur-informatique-industrielle-h-f-112080)

# [Sr CloudOps Engineer (Developer Relations)](https://www.remotewlb.com/apply/sr-cloudops-engineer-developer-relations)  
### Palo Alto Networks  
...
Cloud Ops forms part of the Cloud Services team that has an exciting and challenging mission: Build, deploy, operate, scale and maintain company-wide platforms (PaaS) for customer facing Palo Alto Networks solutions. While various development groups focus on building our platforms, Cloud Ops provides operational/engineering support for both the platform as well as the product teams that leverage the platforms.

We are a trusted partner to our clients based on proven track record to meet Service Level Agreements (SLAs) for specific services we charge our clients Platform Operations, Service Support, and Cloud Engineering. We have two additional services that round out CloudOps Architecture team and Finops.

 **Your Impact**

  * Support and maintain global application production environments
  * Automate common, repeatable tasks at large scale
  * Install, configure, and upgrade custom and packaged applications
  * Be an escalation point for issues as required
  ...
  * Promote the CloudOps and SRE mindset

###  **Qualifications**

 **Your Experience**

  * University degree (BS/MS) in Computer Science, Computer Engineering or equivalent or equivalent military experience
  * Career level experience (minimum 5 years)
  * Understanding of cloud networking concepts (VPC, DirectConnect, GCP Shared Networks…)
  * 2+ years of experience with managing major CSP such as GCP or AWS
  * Experience designing cloud network architectures at scale
  * Ability to hit the ground running and provide value immediately

 _Desirable_

  * Experience with configuration management tools such as Terraform or equivalent
  * Scripting experience in some major programming languages (Python, Go)
  * Certification in cloud technologies (cloud architecture, security or equivalent)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/sr-cloudops-engineer-developer-relations)

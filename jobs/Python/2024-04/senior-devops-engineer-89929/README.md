# [Senior DevOps Engineer](https://www.remotewlb.com/apply/senior-devops-engineer-89929)  
### Social Discovery Group  
#### `💰 bonuses up to $5000, health benefits, professional training, workplace organization perks` `🌎 Poland, Georgia, Serbia`  
...
We are looking for a **Senior DevOps** **_for one of our investment AI products_.**

**Your main tasks will be:**

  * Development of DevOps in the company, automation of code development and delivery processes;
  * Development and operation of a high-load fault-tolerant ML system based on Kubernetes on top of bare metal;
  * Incident investigation and resolution.

**We expect from you:**

  * Kubernetes on-prem, ansible, terraform;
  * AWS/GCP, Gitlab CI/CD, Helm, Python/Go;
  * Understanding of SRE and DevOps principles.

**Would be a plus:**

  * ArgoCD, RabbitMQ, MongoDB, ELK, Prometheus;
...
![](https://remotive.com/job/track/1904566/blank.gif?source=public_api)  
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-devops-engineer-89929)

# [Sr. Technical Support Engineer, Focused Services](https://www.remotewlb.com/apply/sr-technical-support-engineer-focused-services-90427)  
### Palo Alto Networks  
#### `💰 USD 108k~175k` `🌎 US,Remote,Plano, TX`  
 ...
 **Your Experience**
  ...
  * Deep understanding of TCP/IP and advanced knowledge of LAN/WAN technologies, expertise with general routing/switching, Routing protocols (e.g BGP, OSPF, EIGRP), branch, and center architectures
  * Advanced knowledge of packet flow and how it traverses through multiple OSI layers
  * Expertise with troubleshooting Remote Access VPN solutions including IPSEC, PKI & SSL technologies
  * Independently debug broad, complex, and unique networks with mixed media and protocols required
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/sr-technical-support-engineer-focused-services-90427)

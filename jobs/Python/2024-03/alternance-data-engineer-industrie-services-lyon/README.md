# [Alternance - Data Engineer - Industrie & Services - Lyon](https://www.remotewlb.com/apply/alternance-data-engineer-industrie-services-lyon)  
### Sopra Steria  
#### `🌎 France`  
...
Au sein de l'agence de Lyon, vous avez l’opportunité de travailler pour des clients locaux sur des projets du secteur industriel et automobile. Intégré/e à une équipe projet, vous êtes un/e acteur/trice clé/e de la transformation digitale en participant à la conception et l’implémentation de solutions à valeur ajoutées pour nos clients.
...
\- Technologies : Azure Databricks, Python, PowerBI
...
Au-delà de votre expérience et formation, votre personnalité et votre potentiel feront la différence avec bien sûr une de bonnes bases Data.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/alternance-data-engineer-industrie-services-lyon)

# [Research Analyst, Remote](https://www.remotewlb.com/apply/research-analyst-remote-67024)  
### Aledade  
#### `🌎 United States`  
The Research Analyst will help evaluate Aledade programs and interventions and manipulate a variety of data sources (e.g., national Medicare claims, other payer claims, electronic health records, and event notification data). They will work cross-functionally with partners across the organization to surface insights on program performance and support recommendations for prioritization and improvement.  
Primary Duties:
...
### Design and execute analyses:
  ...
  * Design descriptive statistical analyses to answer key business questions. 
...
### Translate and communicate analysis results:
  ...
  * Assist in working across teams at Aledade to identify implications of analysis results and translate findings into action.
  * Develop analytic products that accurately communicate insights from the data and inspire action. 
  * Work closely with engineering and other product partners to enable analytic solutions.

### Minimum Qualifications:

  * Bachelor’s degree and 4+ years of relevant experience. Advanced degree may substitute for some experience.
...
### Preferred Qualifications:
  ...
  * Masters in a related social science (e.g., economics, public health, health policy, public policy), statistics, mathematics, or computer science
  ...
  * Exposure to causal inference methods including designing and/or conducting experimental and quasi-experimental studies (e.g., randomized trials; regression discontinuity, difference-in-differences, instrumental variables, and matched designs).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/research-analyst-remote-67024)

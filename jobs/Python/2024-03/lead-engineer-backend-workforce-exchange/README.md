# [Lead Engineer Backend, Workforce Exchange](https://www.remotewlb.com/apply/lead-engineer-backend-workforce-exchange)  
### Eightfold AI  
...
At WFX, we're not just a product; we're the architects of change in the world of employment. Here's how we're revolutionizing the industry:

Effortless Hiring for All: Whether it's a corporate giant or a dynamic startup or a small company, WFX empowers companies of all sizes to effortlessly post job opportunities, connecting them with top talent.

Empowering Job Seekers: WFX simplifies the job hunt, ensuring they find your perfect match in record time.

Guiding their Career Journey: Beyond job matching, WFX connects job seekers with dedicated career supporters who provide personalized guidance, shaping their path to success.

Committed to Blue and Grey Collar Workforce: We specialize in uplifting the foundation of industries - the blue and grey-collar workforce. As we expand and enhance the WFX experience, we're looking for engineers who are passionate about shaping the future of employment to join our team.

  

 **What You'll Do:**

  * Lead the projects/PODs end to end
  * Lead the design discussion by working closely with the product managers, designers, and other cross-functional teams.
  * Mentor the juniors by performing code reviews.
  ...
  * Design and develop safe and reliable data pipelines for high-scale data integration for fortune 500 customers.
 ...
 **What We Need:**
  ...
  * A solid grounding in Computer Science fundamentals with hands-on experience in back-end development of 6 to 10 or more years.
  * Hands-on experience leading the projects/features/POD
  ...
  * Ability to develop software/code in one mainstream programming language (brownie points if you know Python)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/lead-engineer-backend-workforce-exchange)

# [Research Scientist, Remote](https://www.remotewlb.com/apply/research-scientist-remote-67136)  
### Aledade  
#### `🌎 United States`  
The Research Scientist will lead the production of new products related to risk adjustment and analytics that leverage rich data sources including national CMS reports, payer claims, electronic health records, and performance and financial data models. They will work cross-functionally with partners across the product, finance and performance organizations to surface insights on risk adjustment performance and projections. Additionally the Research Scientist will serve as a thought leader relatively to long term risk adjustment projection and policy/environmental impacts to quantifying risk.  
Primary Duties:

### Identify analysis priorities:

  * Lead efforts with teams across Aledade to proactively identify and clarify important strategic and tactical questions for data analysis and experiments.

### Design and execute analysis projects:

  * Design descriptive, predictive, and/or causal inference statistical analyses for large scale projects and complex business questions.
  ...
  * Supervise junior colleagues in programming and model implementation for small scale projects.

### Translate and communicate analysis results:

  * Lead efforts across teams at Aledade to synthesize results from complex analyses, identify implications of analysis results and translate findings into action.
  * Lead and supervise development and presentation of analytic products that accurately communicate insights from the data and inspire action. 
  * Work closely with engineering and other product partners to enable analytic solutions.

### Minimum Qualifications:

  * Bachelor’s degree and 8+ years of relevant experience. Advanced degree may substitute for some experience.
...
### Preferred Qualifications:
  ...
  * Masters in statistics, mathematics or finance
  * Experience in payer risk adjustment and risk score calculation/projection 
  ...
  * Knowledge of standard methods for measuring risk adjustment, condition prevalence and trends
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/research-scientist-remote-67136)

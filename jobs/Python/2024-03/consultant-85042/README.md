# [Consultant](https://www.remotewlb.com/apply/consultant-85042)  
### Vendavo  
#### `💰 170000.0` `🌎 United States`  
We’re a growing team, and as we scale, so does our need to focus on expanding our Professional Services team. You’ll be joining a people-focused company, and as a Consultant, you will belong to a team of problem solvers with extensive consulting and industry experience. Your duties and responsibilities will span technology design, stakeholder management, pricing strategy, delivery quality, process reengineering, and ad hoc analytics. You will build your own and the team’s technical and business acumen while driving substantial financial benefits to our clients’ bottom line.

### THE OPPORTUNITY

  * Partners with customers to gather functional requirements and propose best practices for utilizing our modules
  * Provides recommendations to product managers for enhancements to our modules to provide additional value to our customers
  * Responsible for documentation, mocks ups and working with developers to ensure they understand what is to be delivered
  * During engagement will be verifying user stories build, conducting sprint demos and train the trainer sessions
  * Other duties as assigned.

### THE SKILL SET

  * Bachelors Degree with ability to travel up to 40% when necessary
  * Minimum 2 years experience as a technical or implementation consultant
  * Minimum 2 years experience as a pricing practitioner (B2C or B2B)
  * Industry experience with commercial systems (ERP, CRM, CLM, CPQ, etc)
  * Experience with agile software implementation methodologies, requirements management and functional design documentation
  * A robust analytical skill set, with an exceptional eye for accuracy.
  * Prior experience as a B2B pricing practitioner or consultant highly preferred.
  * Industry experience with commercial systems (ERP, CRM, CLM, CPQ, etc).
  * Confident self-starter comfortable driving results in the presence of ambiguity.
  * Ability to plan, prioritize and manage time to meet project deliverables.
  * Experience with agile software implementation methodologies, requirements management and functional design documentation.
  * Proficiency in any/all of the following would be a plus: PROSCI, JIRA, R/Python, and Agile.
...
The national minimum salary is $85,000 a year + bonus and benefits. The successful candidate’s starting salary will be determined based on permissible, non-discriminatory factors such as skills, experience, and geographic location.  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/consultant-85042)

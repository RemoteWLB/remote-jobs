# [Python Engineer (m/f/x) onsite or remote (in Germany or Austria)](https://www.remotewlb.com/apply/python-engineer-m-f-x-onsite-or-remote-in-germany-or-austria-74362)  
### Scalable GmbH  
#### `🌎 Germany`  
...
In Scalable’s expanding Financial Engineering, we are looking for Python developers for a new team which focuses on deploying data products and developing software solutions. You will be creating and improving our next generation wealth management and building regulatory market risk controlling systems. The successful candidate will have a solid background in our tech stack, including Python but also Java/Kotlin, Docker, and Spring Boot, and must be well-versed in AWS services such as Lambda, SQS, SNS, and ECS. A strong understanding of SQL is also crucial for this role.
...
### Qualifications
  ...
  * 3+ years of full backend experience in Python (mandatory) alongside Java/Kotlin, JWT, Docker, Spring, AWS, Git, GraphQL, RESTful API
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/python-engineer-m-f-x-onsite-or-remote-in-germany-or-austria-74362)

# [Software Engineer - Cloud Access Security Broker (CASB)](https://www.remotewlb.com/apply/software-engineer-cloud-access-security-broker-casb)  
### Cloudflare  
...
### Technologies we use:
  ...
  * CASB core services are written in Python with Celery as our task queue.
  * Our REST API is written in Python, with Django Rest Framework.
  * We utilize Postgres as our data store and Redis as our cache and message broker.
  * Our scanning engine relies heavily on Kafka.
...
**Examples of desirable skills, knowledge and experience:**
  ...
  * Minimum 3 years of professional experience building and managing reliable and performant software systems at scale, preferably with Python and/or Postgres.
...
### Bonus
  ...
  * Frontend programming experience in Typescript/Javascript
  * Previous experience working with third-party API integrations
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-cloud-access-security-broker-casb)

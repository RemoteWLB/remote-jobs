# [Session Lead (External Contractor) - Python for AI Programmers + Generative AI F](https://www.remotewlb.com/apply/session-lead-external-contractor-python-for-ai-programmers-generative-ai-f)  
### Udacity  
####  

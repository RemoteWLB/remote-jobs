# [Senior Data Analyst (Sales)](https://www.remotewlb.com/apply/senior-data-analyst-sales-79693)  
### Calendly  
#### `💰 324300.0` `🌎 United States`  

### **About the team & opportunity**

What’s so great about working on Calendly’s Marketing team?

Calendly is the scheduling automation platform used by millions of users for eliminating the back-and-forth emails to find the perfect time — and so much more. Our Go to Market Analytics team is made up of Data Analysts who develop reporting, insights, and serve as a consultative partner to our Sales and Marketing organizations. You will have your hands on our self-serve product-led business and our sales-led pipeline-oriented business, supporting the team in making decisions, optimizing sales strategies, and enhancing customer acquisition – ultimately driving business growth.

We're seeking a dynamic Senior Data Analyst to support our Sales team. You should have significant experience with sales analytics as a key focus but you may find yourself working with Growth, Brand, International, or other teams in a typical week too! Reporting to the Senior Manager of Go-to-Market Analytics, you'll collaborate closely with the Sales and Revenue Ops teams, our analysts, and our data and analytics engineering team. Your role is crucial in providing insights and analytics support, driving effective decision-making and optimizing sales strategies.

Utilizing Tableau for dashboard creation, notebook tools for ad hoc analyses, and crafting decks for larger commercial storytelling, you'll also play a crucial role in supporting Sales operational efficiency, leveraging your expertise in Salesforce to optimize workflows and processes. As the commercial partner, you'll provide insights through data-driven recommendations to propel our business forward and have an important role to play in ensuring that we have the right data, tooling, and strategy to provide support to the team.

###  **A day in the life of a Senior Data Analyst at Calendly**

Utilize your extensive knowledge of sales to deliver value through reports, various BI tools, and in-depth analyses. Leverage your experience in data and analytics to tackle complex questions and support business owners on experimentation, data collection, and analysis. Partner closely with our Product and Data Engineering organizations to ensure you have the data you need, and support standardized tracking of sales events through Salesforce and Clari. Take ownership of building weekly performance reporting and work towards automating the reporting package.

###  **On a typical day, you will be working on:**

  * Strategically partner with the Sales and Revenue Ops teams to fulfill their data needs and optimize sales strategies.
  ...
  * Utilize data-driven insights to refine and optimize sales strategies, including lead scoring, routing changes, and process enhancements.
  * Analyze sales data, attribution models, and lead generation metrics to identify trends, opportunities, and areas for optimization, driving improvements across various sales functions.
  * Utilize predictive analysis techniques to forecast future sales trends and outcomes, enhancing the team's ability to anticipate market changes and capitalize on opportunities.
  ...
  * Assist with ad hoc data analysis requests from various teams, demonstrating flexibility and the ability to support the wider Sales & Marketing functions strategically as a generalist, when needed. Analyze the effectiveness of different go to market strategies and tactics, offering insights to enhance targeting, messaging, and overall performance.
  * Collaborate with the Sales and Revenue Ops teams to build and maintain reports that track the performance of various sales campaigns and channels, enabling data-driven decision-making.
  ...
  * Catalog sales and user data in dbt, and contribute to shaping our new data model in BigQuery, enhancing the overall data infrastructure.

###  **What do we need from you?**

  * 3-5 years of hands-on experience in a role focused on analytics or data science, showcasing a strong background in sales and revenue operations analytics, with demonstrated/credentialed expertise in Salesforce. Experience with platforms such as Clari, Marketo, etc. is a plus.
...
Base Pay Range National - Salary$103,700—$140,300 USDBase Pay Range California - Salary$136,000—$184,000 USD  
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-data-analyst-sales-79693)

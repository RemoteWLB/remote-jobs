# [Graphics Software Kernel Mode Engineer - Staff](https://www.remotewlb.com/apply/graphics-software-kernel-mode-engineer-staff)  
### Qualcomm  
#### `💰 ~208k` `🌎 San Diego, CA,US,Remote`  
 ...
 ** _Principal Duties and Responsibilities:_**
  ...
  * Applies Graphics knowledge to assist in the architect, design, implementation, and verification of the structure and performance of GPU hardware, drivers, features, applications, and tools.
  * Writes code for well-defined features, drivers, and APIs using different languages (e.g., C, C++, perl, python).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/graphics-software-kernel-mode-engineer-staff)

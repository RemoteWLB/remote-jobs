# [Senior Data Analyst, Growth Marketing](https://www.remotewlb.com/apply/senior-data-analyst-growth-marketing-58927)  
### HopSkipDrive  
...
Reporting to the Director of Growth Marketing, the ideal candidate has a strong foundation in operational process management, marketing analytics, data strategy, and possesses the drive to advance their career in a rapidly growing technology company. You will be a key contributor to Supply Strategy and work in close collaboration with the Supply Leadership team.
...
### What you’ll do:
  ...
  * Be a data analyst within the Supply team working to improve performance across the entire department. Including Acquisition, Activation, Retention, Community Engagement and Support 
  * Evaluate all existing Supply Data management processes and recommend improvements in tools, metric inputs and predicted outputs
  * Manage the Supply Tableau Dashboard. Working to surface actionable insights and recommendations using data visualizations and presentations to a range of stakeholders
  * Significant contributor to the Supply forecasting process using process variables to predict cost and volume required to produce efficient supply to allow for unconstrained Demand growth 
  * Responsible for ongoing description of the dynamic relationship between CAARD expenditures and key Marketplace KPI’s
  * Collaborate with marketing stakeholders to design A/B and multivariate tests, and report on performance (digital ads, email campaigns, TV, etc.), marketing attribution, and campaign effectiveness
  * Inform decisions about marketing spend allocations, ad partners for future campaigns, product features and instrumentation enhancements
  * Develop tools from simple dashboards to marketing & media mix models and multi-touch attribution solutions
  * Gather and analyze data from a variety of sources (including but not limited to Facebook, Google, Pinterest, Google Analytics, offline media dashboards) to improve the effectiveness of marketing efforts throughout the CareDriver lifecycle
  * Ensure quality of data and tracking
  * Facilitate the establishment and measurement of key metrics and analyze traffic patterns to measure attribution and performance of marketing programs
  * Uncover pipeline and campaign performance gaps
...
### What you'll need:
  ...
  * 4+ years of marketing analytics experience across ad efficacy, data science or business intelligence engineering teams within the tech space
  ...
  * Strong experience developing solutions in SQL, Tableau
  ...
  * Current pulse on digital platforms, tools, and trends in media and advertising
  * Deep and broad knowledge of ad measurement ecosystem (e.g., lift testing, multi-touch attribution, app install measurement, reach/audience) and industry trends

### Nice to Have:

  * Marketplace company experience
  * Experience with causal inference techniques, econometrics, bayesian and/or frequentist hypothesis testing
  * Google Tag Manager, Mobile Measurement Partner (Branch, Appsflyer, Adjust, Kochava), Iterable (or HubSpot, Marketo)
  * Data engineering and data pipeline experience.
  * Python, R or shell scripting
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-data-analyst-growth-marketing-58927)

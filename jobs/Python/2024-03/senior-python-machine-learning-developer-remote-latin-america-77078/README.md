# [Senior Python/Machine Learning Developer - Remote - Latin America](https://www.remotewlb.com/apply/senior-python-machine-learning-developer-remote-latin-america-77078)  
### FullStack Labs  
#### `🌎 Peru`  
...
We're looking to hire a Senior Python/Machine Learning Developer to join our team. You'll work with our incredible clients in one of two ways:

  *  _Team Augmentation_ : You will integrate yourself directly into our client's team and work alongside their existing designers and engineers on a daily basis.
  *  _Design Build:_ You will work on a FullStack Labs product team to build and deliver a product to our clients.

### What We're Looking For:

  * 6+ years of professional software development experience.
  * Proven experience working with Python.
  * Proven experience working with Machine Learning.
  * Proven experience working with Azure.
  * Proven experience working with SQL.
  * Proficiency with Spark or PySpark, NoSQL.
  * Proficiency with SOA architecture (ideally microservices) and serverless focus on cloud-based SaaS application development.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-python-machine-learning-developer-remote-latin-america-77078)

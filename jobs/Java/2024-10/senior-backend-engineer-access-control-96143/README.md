# [Senior Backend Engineer, Access Control](https://www.remotewlb.com/apply/senior-backend-engineer-access-control-96143)  
### Webflow  
#### `💰 $158,000 - $248,000` `🌎 U.S. Remote`  

At Webflow, our mission is to bring development superpowers to everyone. Webflow is the leading visual development platform for building powerful websites without writing code. By combining modern web development technologies into one platform, Webflow enables people to build websites visually, saving engineering time, while clean code seamlessly generates in the background. From independent designers and creative agencies to Fortune 500 companies, millions worldwide use Webflow to be more nimble, creative, and collaborative. It’s the web, made better.

The Access Control team at Webflow is looking for a **Senior Backend Engineer** who is experienced with permission systems and values building secure software that also has a great user experience. The team is responsible for building and maintaining the Roles & Permissions framework used by all of Engineering to make sure the right users have access to the right resources throughout the webflow.com application. The team is also responsible for building and maintaining features that enable customers to define access control control policies for their own workspaces.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-backend-engineer-access-control-96143)

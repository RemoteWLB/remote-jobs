# [Softwaretester Testautomatisierung (all gender)](https://www.remotewlb.com/apply/softwaretester-testautomatisierung-all-gender)  
### ALTEN  
 ...
 **DU...**
  ...
  * unterstützt das Team bei der Umsetzung von qualitätssteigernden Maßnahmen
  * kümmerst dich um Design, Dokumentation und Durchführung von manuellen und automatisierten Testabläufen
  * überwachst die Testdurchführung und kümmerst dich um die Fehlerverfolgung
  * optimierst bestehende Prozesse und Tools und bringst neue Ideen ein
  * leitest selbstständig Testteams

###  **Qualifications**

 **DU...**

  * hast ein abgeschlossenes Studium im Fachbereich der Informatik, Angewandter Informatik oder Elektrotechnik
  * bringst relevante Berufserfahrung im Softwaretesting, insbesondere bezogen auf Testautomatisierung mit
  * hast fundierte Kenntnisse mit gängigen Sprachen/Skriptsprachen (Java/JavaScript)
  * verfügst über Kenntnisse mit Test-Frameworks wie Selenium, JUnit, Jenkins, Gradle oder vergleichbaren Werkzeugen
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/softwaretester-testautomatisierung-all-gender)

# [Alternance Développeur(se) – Java – Industrie & Services - Tours](https://www.remotewlb.com/apply/alternance-developpeur-se-java-industrie-services-tours)  
### Sopra Steria  
#### `🌎 Remote,Tours, France`  
...
Technologies utilisées : Java EE, Angular, Hibernate, Spring, SQL, Eclipse, Tomcat, Maven

###  **Qualifications**

 **Votre profil :**

Etudiant(e) en école d'ingénieur ou Master Informatique ou équivalent, vous cherchez une alternance de 12 à 24 mois.  
  
Vous êtes autonome, rigoureux (se) et vous êtes reconnu(e) pour vos capacités relationnelles.  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/alternance-developpeur-se-java-industrie-services-tours)

# [Senior Software Engineer, Android Apps](https://www.remotewlb.com/apply/senior-software-engineer-android-apps-91449)  
### Flock Safety  
#### `🌎 Remote, US`  
...
**The First 30 Days**
  ...
  * Learn about the flock applications that keep the devices up-to-date and reporting the health of the device and its peripherals 
  * Create internal dashboards to monitor the health of the applications

**The First 60 Days**

  * Triage issues coming from the field related to the health of the devices in the field 

**90 Days & Beyond**

  * Triage issues coming from the field related to the health of the devices in the field 
  * Re-architecture of the applications like the device application updater to make it common across all the android versions
  * Design and implement mechanisms to improve power utilization on Flock devices
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-android-apps-91449)

# [SR Desenvolvimento Java (Legado)](https://www.remotewlb.com/apply/sr-desenvolvimento-java-legado)  
### ília  
#### `🌎 Remote (anywhere on the globe)`  
...
### Responsabilidades e atribuições:
  ...
  * Manutenção nas funcionalidades existentes

  * Documentação técnica dentro do escopo do projeto

  * Análise e correção de problemas em ambiente produtivo

  * Colaboração com o time na definição de novas abordagens ou tecnologias

### Requisitos:

Para esta posição, é necessário que o profissional tenha experiência em:
...
### Benefícios e incentivos:
  ...
  * Universidade Corporativa: Linkedin Learning e Language Academy para desenvolvimento de skills;
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/sr-desenvolvimento-java-legado)

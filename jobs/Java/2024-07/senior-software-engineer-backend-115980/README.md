# [Senior Software Engineer (Backend)](https://www.remotewlb.com/apply/senior-software-engineer-backend-115980)  
### Useinsider  
...
### A Senior Software Engineer in Insider day in and day out:

* designs, implements and maintains APIs and services,
* collaborates with other engineers and teams to build new features at scale,
* debugs issues across services and multiple levels of the stack,
* monitors performance, throughput, latency and SLA to build and maintain the services.
...
* have experience developing services using Scala, Go, Python and Node.js
* have 5+ years of experience in building and operating highly available APIs,
* have experience with SQL databases and NoSQL databases in a production environment such as Elasticsearch, Redis, DynamoDB etc.,
* have good knowledge in developing or managing event-driven architecture or microservices,
* have good knowledge of software engineering best practices across the development lifecycle, 
* including agile methodologies, coding standards, code reviews, source management, build processes, testing, and deployments,
* preferably have experience with AWS and working with technologies such as AWS Lambda, API Gateway, Kinesis, SQS
* preferably have experience with Kubernetes,
* preferably have experience with machine learning platforms,
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-backend-115980)

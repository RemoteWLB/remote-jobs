# [Principal Software Engineer - Java](https://www.remotewlb.com/apply/principal-software-engineer-java-109321)  
### Veeva Systems  
#### `💰 $150,000 - $300,000` `🌎 remote,Indiana - Indianapolis`  
...
* Hands-on development experience with current open source tools and technologies (Java, Spring, MySQL, Hibernate, Maven, Git, Jenkins), AWS Components (S3, RDS, EC2, EKS, MSK, and more) and Containers (Docker, K8s)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/principal-software-engineer-java-109321)

# [Full Stack Engineer, Identity & Onboarding](https://www.remotewlb.com/apply/full-stack-engineer-identity-onboarding)  
### None  
#### `💰 $175,000 - $240,000/yr` `🌎 United States (Remote)`  
...
As a Software Engineer on the Identity and Onboarding team, your role is pivotal in optimizing our onboarding funnel to ensure maximum approval rates with minimal drop-off, directly contributing to One’s overarching vision of seamless user experiences. The team’s efforts in scaling existing channels, adding new ones, and refining our authentication platform are crucial for enhancing customer satisfaction, reducing operational costs, and maintaining high levels of account security, aligning directly with One’s mission and goals

This role is responsible for:

  * Full stack delivery and working closely with other engineers to ship code. We enjoy collaboration and partnering on hard problems. 

  * Building and maintaining documentation. As a growing and remote organization, having the necessary docs are key to our success. 

  * Solving complex problems that arise at scale. We deal with real-world money movement, sensitive financial data at scale, and are creating novel financial mechanics with no real precedent.

# You bring

  * 5+ years of professional experience in a Full Stack software engineering role.
  ...
  * Experience managing applications in a production environment that supports high availability, resilience, and low latency at scale. 
...
The estimated annual base salary for this position ranges from $175,000 to $240,000. Pay is generally based upon the level, complexity, responsibility, and job duties/requirements of the specific position. We then source candidates with the requisite skills, expertise, education, training, and experience. If you are selected for an interview, please feel welcome to speak to a Talent Partner about our compensation philosophy and other available benefits.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/full-stack-engineer-identity-onboarding)

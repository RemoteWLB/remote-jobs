# [Staff+ Software Engineer, Product](https://www.remotewlb.com/apply/staff-software-engineer-product)  
### None  
#### `💰 $195,000 - $250,000/yr` `🌎 United States (Remote)`  
...
# You bring
  ...
  * 8+ years of professional experience in product-facing backend development.
...
The estimated annual base salary for this position ranges from $195,000 to $250,000. Pay is generally based upon the level, complexity, responsibility, and job duties/requirements of the specific position. We then source candidates with the requisite skills, expertise, education, training, and experience. If you are selected for an interview, please feel welcome to speak to a Talent Partner about our compensation philosophy and other available benefits.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-engineer-product)

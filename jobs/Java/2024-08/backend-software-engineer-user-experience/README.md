# [Backend Software Engineer, User Experience](https://www.remotewlb.com/apply/backend-software-engineer-user-experience)  
### None  
#### `💰 $135,000 - $220,000/yr` `🌎 United States (Remote)`  
...
Software Engineers on One’s Core App Team own the mobile and web codebase that drives our user experience. Besides writing, reviewing, and shipping code, engineers collaborate with others across the company, from Product, Design, and Data to, Customer Support, Ops, and Compliance. Software Engineers at One are highly technical, communicative, and emotionally intelligent.  

  * Work closely with other engineers to ship code. We enjoy collaboration and partnering on hard problems. 

  * Collaborate with cross-functional teams to define and prioritize features and technical initiatives.

  * Lead the technical planning and architecture discussions for frontend systems.

  * Add to the overall user experience through surprise and delight.

  * Build and maintain documentation. As a growing and remote organization, having the necessary docs are key to our success. 

# You bring

  * 5 + years of professional experience building, shipping — and growing — with a User-centric approach

  * Proactively seek opportunities to improve user experience through backend optimizations and enhancements
  ...
  * Proven track record of making impactful improvements to user experience
...
The estimated annual base salary for this position ranges from $135,000 to $220,000. Pay is generally based upon the level, complexity, responsibility, and job duties/requirements of the specific position. We then source candidates with the requisite skills, expertise, education, training, and experience. If you are selected for an interview, please feel welcome to speak to a Talent Partner about our compensation philosophy and other available benefits.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/backend-software-engineer-user-experience)

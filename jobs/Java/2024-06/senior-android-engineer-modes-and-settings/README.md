# [Senior Android Engineer, Modes and Settings](https://www.remotewlb.com/apply/senior-android-engineer-modes-and-settings)  
### Block  
...
The Square Point of Sale mobile applications are the main entry point through which merchants interact with Square. The Modes and Settings team is responsible for building and maintaining the remote settings and configuration management infrastructure that our sellers interact with many times a day.

To learn more about Point of Sale:

 **https://squareup.com/us/en/point-of-sale/software**

 **As an Android Engineer on the team, you’ll need to:**

  * Be proficient in Java and/or Kotlin for development (we use both).
  * Lead the engineering implementation of seller-facing projects, from conceptualization to rollout.
  * Enjoy working on mobile apps at all levels – from networking to user interfaces and whatever’s in between.
 ...
 **You Have:**
  ...
  * [Preferred] Experience with developing mid to large scale complex features.
  * [Preferred] Experience with SDK or Framework development.
  * Excellent software engineering aptitude and a product mindset.
  ...
  * A strong sense of customer empathy and an interest in influencing the product direction.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-android-engineer-modes-and-settings)

# [Senior Business Intelligence Engineer](https://www.remotewlb.com/apply/senior-business-intelligence-engineer-111052)  
### Block  
...
The Business Intelligence (BI) Team at Cash App enables our teams to make impactful business decisions through data architecture, modeling, pipeline tooling and dashboarding. As a Senior BI Engineer at Cash App, you will work with Analysts, Data Scientists, Software Engineers and Product Managers to lay the foundation for analyzing our large, unique dataset. We are an extremely data-driven team - from understanding our customers, managing and operating our business, to informing product development. You will build, curate, document, and manage key datasets and ETLs to increase the effectiveness of the entire team.

 **You will** :

  * Create brand new and optimize existing data models for Customer Support (CS) organization
  * Build reusable frameworks that improve the reliability and scalability of our ETLs
  ...
  * Work to influence the greater CS org to create an amazing data environment
 ...
 **You have** :
  ...
  * Extensive work with ETL orchestration and workflow management tools like Airflow, Prefect 
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-business-intelligence-engineer-111052)

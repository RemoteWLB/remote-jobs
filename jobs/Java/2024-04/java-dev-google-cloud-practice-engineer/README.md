# [Java Dev Google Cloud Practice Engineer](https://www.remotewlb.com/apply/java-dev-google-cloud-practice-engineer)  
### Rackspace  
#### `💰 USD 103k~150k` `🌎 US,Remote`  

Description

As a full spectrum integrator, we assist hundreds of companies to realize the value, efficiency, and productivity of the cloud. We take customers on their journey to enable, operate, and innovate using cloud technologies – from migration strategy to operational excellence and immersive transformation.
...
•The anticipated starting pay range of California, Washington state and New York City applicants for this role is $112,600 - $150,130.

•The anticipated starting pay range of Colorado applicants for this role is $103,500 - $137,100.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/java-dev-google-cloud-practice-engineer)

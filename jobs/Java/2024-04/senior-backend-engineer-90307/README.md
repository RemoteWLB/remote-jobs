# [Senior Backend Engineer](https://www.remotewlb.com/apply/senior-backend-engineer-90307)  
### Underdog Fantasy  
#### `💰 USD 150000.0~210000.0` `🌎 United States`  
...
###  **About the role and why it’s unique:**
  ...
  * As a Senior Backend Engineer on the Data Platform team, you’ll be developing and deploying internal APIs and workflows to enable seamless integration between Underdog’s internal services
  * Design, develop, and maintain RESTful APIs and microservices to enable efficient data retrieval and processing for internal applications
  * Greenfield and architect new backend systems for scalability, fault tolerance, and performance for a core part of Underdog’s future business
  * Collaborate with engineers, product owners, and data scientists to understand requirements and translate them into scalable technical solutions
  * Implement and maintain monitoring, alerting, and logging mechanisms to ensure the health and accuracy of Underdog’s engineering systems
  * Mentor junior engineers, lead technical initiatives, and drive results in a fast-paced, dynamic environment
  * Lead code reviews, provide constructive feedback, and evangelize best practices to maintain code quality

###  **Who you are:**

  * At least 6 years of experience building microservices heavy backend systems and APIs for internal applications on a cloud environment (e.g. AWS, GCP, Azure)
  ...
  * Advanced proficiency with Go, C++, Java, or other similar programming languages (at least 2)
...
###  **Even better if you have:**
  ...
  * Prior experience developing production systems in Rust
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-backend-engineer-90307)

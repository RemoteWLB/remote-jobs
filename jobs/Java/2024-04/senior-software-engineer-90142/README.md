# [Senior Software Engineer](https://www.remotewlb.com/apply/senior-software-engineer-90142)  
### AT&T  
#### `💰 USD 116k~196k` `🌎 Dallas, TX,Remote,US,Atlanta, GA`  
...
The Senior Software Engineer is Responsible for the overall delivery process of a software application or service, including design, development, testing, deployment, production application support (e.g., troubleshooting) and maintenance with a focus on automation. Collaborate to gather and review software requirements/user stories, provide estimates, create software design specifications and collaborate with engineers/architects to assess and test hardware and software interactions. Execute a specific development methodology through application of various programming languages.
...
• 3+ years of experience in working in Engineering or Development roles.  
• 3+ years of progressive experience in one or more of the following areas: application delivery; subject matter expertise in building Java-based high-volume/high-transaction e-commerce applications.  
• 3+ years of experience building web applications using Java, Spring and REST.  
• 2+ years of experience in performance tuning and application monitoring.  
• 2+ years of experience in architecture and design of systems using Micro services architecture.  
• 2+ years of experience in a leadership capacity - coaching and mentoring engineers, developers.  
• 1+ years of experience in cloud technologies: AWS, Azure, OpenStack, Docker, Kubernetes, Ansible, Chef or Terraform.  
• 1+ years of experience in build and CICD technologies: GitHub, Maven, Jenkins, Nexus or Sonar.  
...
• Proficient knowledge and experience working with asynchronous message processing, stream processing and event driven computing.  
...
• Good written and verbal communication skills with demonstrated ability to present complex technical information in a clear manner to peers, developers, and senior leaders.  
• Working knowledge of product catalogs - Commerce Tools, Amdocs Catalog One.

Our Senior Software Engineering earns between $130,700.00-$196,100.00.  Not to mention all the other amazing rewards that working at AT&T offers. Individual starting salary within this range may depend on geography, experience, expertise, and education/training.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-90142)

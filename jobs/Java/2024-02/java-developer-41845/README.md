# [Java Developer](https://www.remotewlb.com/apply/java-developer-41845)  
### DigitalOnUS  
...
We're looking for a passionate, **Java Developer**. We believe that working hard is a byproduct of loving what you do and not something that can be me assured on a timesheet.

**Location: Remote position (México).**

**Requirements:**

  1. Mandatory skills: Java, SpringBoot, Kafka, Event Driven Architecture, Reactiva Architecture
  2. Hands-on experience in streaming solution/pub-sub for eg: Kafka, Solace, etc. 
  3. Performance tuning skills – multi threading, monitoring, caching,… (Application level not DB level)
  4. Be able to debug issues using Grafana/Dynatrace/chromosphere/Splunk/kafka/rollbar/cloudwatch..etc.
  5. No SQL database
  6. Basic SQLs to debug data-related issues
  7. Good understanding of different types of testing and their importance
  8. Understanding of CI/CD 

# [Performance Engineer](https://www.remotewlb.com/apply/performance-engineer-36581)  
### DigitalOnUs  
#### `💰 65k-95k USD` `🌎 Mexico`  
...
We look for engineers that demonstrate passion for what they do and develop. They must be curious, persistent to find the right solutions to resolve complex problems and able to communicate and express ideas properly.

We're looking for a passionate, focused **Performance Engineer** candidate to come and we offer a work environment with everything you need to be your best, who has creative ways, and curious about learning to work in a **100% remote schema** for one of the biggest retail companies in the USA. Does Ambition, Success, Fun, Friends Learning define your idea of a career? **Join us and be part of our family!**

### Location: Remote anywhere in Mexico

### Qualifications we are looking for:

 **+5 years of experience in related area, main skills:**
...
### Skills:
  ...
  * Experience driving QA Processes and deliverable in an Agile/Scrum environment.
  * Experience working with remote team.
  * Ability to created short term and long term roadmaps.
  * Ability to communicate effectively to team and leadership roles.
...
### Some qualifications we consider a plus:

  * Experience working with CI/CD tools (preferably GitHub SaaS). Knowledge of  
configuring CI pipelines for integrating tests.

  * Experience with JavaScript, C, Java coding skills.
  * Experience with SQL, NoSQL graph database.

### Job duties:

  * Conduct system performance testing to ensure system reliability, capacity and  
scalability.
  ...
  * Report issues within an agile environment (either Scrum or Kanban, through JIRA  
mainly).
...
### Why will you love this job?
  ...
  * Play with the latest greatest technologies on the test automation field
  * You'll enhance your automation testing expertise
  * Become part of a highly tech-savvy startup that's growing rapidly
  * This role would be able to collaborate with high performance team members building and maintaining systems that power websites and applications people use every day.
  * There is a wide range of technologies, from programming languages and frameworks to other tools this role will be exposed to.

### Your team will:

  * Make our RBAC vision a reality across the stack
  * Develop and maintain critical systems related to Authentication and Authorization

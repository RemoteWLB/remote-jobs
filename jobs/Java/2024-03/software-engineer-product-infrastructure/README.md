# [Software Engineer, Product Infrastructure](https://www.remotewlb.com/apply/software-engineer-product-infrastructure)  
### Whatnot  
...
Product Infrastructure engineers at Whatnot are key to allowing us to build new products and features quickly and reliably, constantly catering towards our fast growing business. To achieve our ambitious scaling goals, we are investing in building a world class product infrastructure. We foster collaborative culture, where product engineering teams work very closely with the infrastructure teams. We ship new features quickly to our users, but we don’t want to compromise the long term stability of our platform. Our business is scaling very quickly, and we're looking for passionate engineers who can help our infra match the growth of the company! The software team has a lot of individual responsibility and many more freedoms, so we need to hire people we can trust. Your ability to translate product strategy into a sound system design is essential to us.
...
#### **👋 You**
  ...
  * Excellent ability to translate product requirements to a scalable system. You first think about users rather than the best technical solution.
  * You are known for high quality of your engineering designs.
  * You’re an excellent problem solver and don’t need to be told exactly what to do.
  * Comfortable working across the stack (backend and frontend).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-product-infrastructure)

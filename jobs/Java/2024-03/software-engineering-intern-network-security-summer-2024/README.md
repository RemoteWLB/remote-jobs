# [Software Engineering Intern (Network Security) - Summer 2024](https://www.remotewlb.com/apply/software-engineering-intern-network-security-summer-2024)  
### Juniper Networks  
#### `💰 ~94k` `🌎 Sunnyvale, CA,US,Remote`  
...
The network security organization develops next-generation security products that enable and secure efficient global communication. The team is seeking open-minded individuals with a track record of accomplishment and follow-through.

Responsibilities vary depending on specific project and may include:

  * Building (developing & testing) multi-service networking and network security products that are the foundation for the internet and its security. 
  * Working on hardware and virtual/containerized systems that secure networks, with functionality such as NextGen Firewalls, Web and SSL Proxies, UTM and VPN. 
  * Resolving internal and external customer issues. 
  * Interfacing with product management team, QA team, platform development team, and other teams responsible for the product development cycle. 

Required background and skills:

  * Currently pursuing a bachelor/master degree in CS/CE/EE 
  * Strong programming fundamentals (e.g., C/C++, Java, Python,...), including the design and implementation of algorithms 
  * Effective verbal and written communication; team player 
  * Ability to come up with creative solutions to challenging problems 

Preferred Qualifications and Interests:

  * Working knowledge of Unix/Linux 
  * Experience leveraging open source code 
  * Network/system security, AI, Big Data Analytics, Data Mining, Hadoop 
  * Familiarity with Routing protocols, Ethernet switching, IP forwarding, Class/Quality of service, Firewall & access control, TCP/IP, UDP 
  * Interest in virtual network and network overlay technologies 
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineering-intern-network-security-summer-2024)

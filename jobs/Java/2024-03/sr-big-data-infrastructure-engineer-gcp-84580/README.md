# [Sr Big Data Infrastructure Engineer (GCP)](https://www.remotewlb.com/apply/sr-big-data-infrastructure-engineer-gcp-84580)  
### Rackspace  
#### `🌎 United States`  
About the Role:We are seeking a highly skilled and experienced Senior Big Data Infra Engineer to join our dynamic team. The ideal candidate will have a strong background in developing and scaling both stream and batch processing systems, and a solid understanding of public cloud technologies, especially GCP. This role involves working in a remote environment, requiring excellent communication skills and the ability to solve complex problems independently and creatively.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/sr-big-data-infrastructure-engineer-gcp-84580)

# [Binance Accelerator Program - Backend Engineer (Big Data)](https://www.remotewlb.com/apply/binance-accelerator-program-backend-engineer-big-data)  
### Binance  
#### `🌎 Taiwan, Taipei`  
...
#### Requirements:
    ...
    * Familiar with the basic technology of Java, with project development experience in SprintCloud and SprintBoot
    * Understand one or several components in Hadoop, Hive, Doris, Flink, Trino, Elastic-search, and Kafka
    * Skilled in communication, especially in cross team collaboration and communication
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/binance-accelerator-program-backend-engineer-big-data)

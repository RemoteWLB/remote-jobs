# [Software Quality Assurance Manager (Remote)](https://www.remotewlb.com/apply/software-quality-assurance-manager-remote)  
### Insider  
...
### A Software Quality Assurance Team Lead in Insider day in and day out:

  * communicates with the Director of Quality Assurance and Development teams to provide a reliable and confident end user experience while developing effective and efficient methods,
  * works with teammates and other departments to resolve issues that arise during updates and the Quality Assurance process,
  * increases quality, ensures security and reduces errors in development,
  * outlines test plans, writing tests, and managing test cases,
  * develops and maintains the Quality Assurance processes of software,
  * works with an agile mindset, adapts quickly to changes and is comfortable with this,
  * knows how to prioritize his work, is flexible with sudden changes in the game plan and when to stick to it,
  * prioritizes and plans Quality Assurance strategies according to business and Quality objectives by talking to Stakeholders,
  * provides testing and quality metrics to key Stakeholders,
  * trains Development and Quality Assurance team members, helps with orientation program and performance monitoring,
  * leads and mentors Quality Assurance projects

### We want you to join us while we are taking a step into the future if you:

  * have **5+ years of experience in Quality Assurance and team management**
  * are familiar with **Quality Assurance and Web Development methodologies and tools**
  *  **have an expert knowledge of Agile Testing Processes**
  * have advanced knowledge and experience with tools such as **Selenium, Appium, Locust and Jenkins**
  * have a good knowledge of **Python and Java**
  * are passionate about problem solving and product quality
...
### While exporting our technology to the world, we offer you:
  ...
  * free access to exclusive services such as **Laracasts, Egghead, Udemy, Blinkist, Masterclass, and Spotify**
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-quality-assurance-manager-remote)

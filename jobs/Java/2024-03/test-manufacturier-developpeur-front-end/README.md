# [Test manufacturier Développeur Front-end](https://www.remotewlb.com/apply/test-manufacturier-developpeur-front-end)  
### Averna  
 ...
 **Test manufacturier Développeur Front-end**
...
En tant que développeur Front-end (partie utilisateur) de test manufacturier, votre expertise en ingénierie logicielle sera mise à profit pour développer des solutions complexes pour l'un de nos clients de premier plan situé dans la région de la baie de San Francisco. Nous vous encouragerons à innover et à exprimer régulièrement vos idées. Nous recherchons une personne passionnée par le travail dans le secteur de la haute technologie.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/test-manufacturier-developpeur-front-end)

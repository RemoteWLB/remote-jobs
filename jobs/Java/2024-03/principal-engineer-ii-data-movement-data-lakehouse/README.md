# [Principal Engineer II - Data Movement/Data Lakehouse](https://www.remotewlb.com/apply/principal-engineer-ii-data-movement-data-lakehouse)  
### GEICO  
#### `💰 ~236k` `🌎 US,Remote`  
...
As a Principal Engineer II, you will:
  ...
  * Be responsible for technical aspects of a solution at the project level
  * Lead critical projects/initiatives
  ...
  * Focus on the quality of the solution. This includes architectural aspects related to performance, scalability, availability, security, and maintainability
  ...
  * Define patterns and solutions for complex problems
  * Coordinate with other business units to ensure work comports with architectural vision for the enterprise. Includes both functional and non-functional requirements
...
### Qualifications
  ...
  *  **Advanced experience working with Spark/Databricks**
  ...
  * Advanced understanding of monitoring concepts and tooling. Experience with Elastic Search, Dynatrace, Thousand Eyes, Influx, Prometheus, Grafana or equivalents
...
###  Experience
  ...
  * 8+ years of professional software development within at least one of the following Java, Spark, Scala, Python
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/principal-engineer-ii-data-movement-data-lakehouse)

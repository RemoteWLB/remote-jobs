# [Senior Infrastructure Engineer (Data Platform)](https://www.remotewlb.com/apply/senior-infrastructure-engineer-data-platform-75723)  
### Angi  
#### `💰 ~200k` `🌎 New York, NY,Remote`  
...
We are seeking a highly skilled Modern Platform Engineer with expertise in Cloud Computing on AWS, running workloads in Kubernetes, and a focus on ML Ops and other Data Engineering workloads. This is a challenging and exciting opportunity for a highly motivated and skilled Modern Platform Engineer to join our team and work on cutting-edge technologies. The ideal candidate will have a deep understanding of cloud infrastructure, containerization, and automation, as well as experience in designing, deploying, and maintaining complex systems. The candidate should also have experience in data engineering, machine learning, and data pipelines. If you are passionate about cloud computing, Kubernetes, and ML Ops or other data engineering workloads, we encourage you to apply.
...
**What you’ll do**
  ...
  * Develop and maintain data pipelines for ML Ops or other data engineering workloads
...
**Who you are**
  ...
  * Experience in ML Ops or other data engineering workloads 
  * Experience in data engineering, machine learning, and data pipelines
...
**Compensation & Benefits**
  ...
  * The salary band for this position ranges from $155,000 - $200,000, commensurate with experience and performance. Compensation may vary based on factors such as cost of living
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-infrastructure-engineer-data-platform-75723)

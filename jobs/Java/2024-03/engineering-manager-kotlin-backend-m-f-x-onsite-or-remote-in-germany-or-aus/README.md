# [Engineering Manager - Kotlin Backend (m/f/x) onsite or remote (in Germany or Aus](https://www.remotewlb.com/apply/engineering-manager-kotlin-backend-m-f-x-onsite-or-remote-in-germany-or-aus)  
### Scalable GmbH  
#### `🌎 Germany`  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/engineering-manager-kotlin-backend-m-f-x-onsite-or-remote-in-germany-or-aus)

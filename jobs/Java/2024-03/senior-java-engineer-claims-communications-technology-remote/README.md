# [Senior Java Engineer - Claims Communications Technology (REMOTE)](https://www.remotewlb.com/apply/senior-java-engineer-claims-communications-technology-remote)  
### GEICO  
#### `💰 ~185k` `🌎 Montgomery, AL,Newark, NJ,Fayetteville, NC,Providence, RI,Nashville, TN,Mobile, AL,Greenville, SC,Huntsville, AL,Washington, D.C.,Detroit, MI,Remote,Virginia Beach, VA,Springfield, MA,Omaha, NE,Oklahoma City, OK,Philadelphia, PA,Burlington, MA,Worcester, MA,Baltimore, MD,Louisville, KY,Savannah, GA,McLean, VA,Hartford, CT,Rochester, NY,New York, NY,Little Rock, AR,Milwaukee, WI,New Orleans, LA,San Antonio, TX,Raleigh, NC,Minneapolis, MN,Austin, TX,Cincinnati, OH,St. Paul, MN,Orlando, FL,Birmingham, AL,Memphis, TN,Champaign, IL,Houston, TX,Cleveland, OH,Atlanta, GA,US,Jackson, MS,Lincoln, NE,Des Moines, IA,Chicago, IL,Gainesville, FL,Springfield, VA,Springfield, MO,Dallas, TX,Indianapolis, IN,Miami, FL,Pittsburgh, PA,Madison, WI,Arlington, TX,Knoxville, TN,Jacksonville, FL,Tulsa, OK,Frederick, MD,Tampa, FL,Boston, MA,Tallahassee, FL,Arlington, VA`  
...
With this massive mission, we are looking to build a strong group of skilled and talented engineers for our **Claims Communications Technology** team that bring a passion for building high-performance, low-latency platforms, and applications. If you are interested in transforming and building a new set of applications for Insurtech, this is a great opportunity to join as a core contributor while we expand our team in this space.

Our Senior Engineer is a key member of the engineering staff working across Business Services Engineering, Data Engineering, Platform Engineering, and Infrastructure Engineering to ensure that we provide a friction-less experience to our customers and maintain the highest standards of protection and availability. The ideal candidate has proven **Java** development experience along with a background in Microservices and Containers Architecture (REST API, Dockers, Kubernetes, ASB) as well as EDA (Event Driven Architecture) using Kafka. Experience in Azure SQL, VM or PostgreSQL is a plus.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-java-engineer-claims-communications-technology-remote)

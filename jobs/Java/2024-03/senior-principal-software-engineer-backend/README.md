# [Senior Principal Software Engineer, Backend](https://www.remotewlb.com/apply/senior-principal-software-engineer-backend)  
### Dataminr  
#### `💰 ~246k` `🌎 US,Remote`  
...
As a Senior Principal Software Engineer you will be joining our fast-moving product engineering team working on the future of our alerting platform. In your day to day you will be architecting and delivering features for a large scale globally distributed platform and set of applications that ingests and processes hundreds of thousands of data points per second. This US-based role can be remote or based out of our New York City office.
...
Colorado: $202,500 - $222,000  
New York/California/Washington: $225,000 - $246,500
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-principal-software-engineer-backend)

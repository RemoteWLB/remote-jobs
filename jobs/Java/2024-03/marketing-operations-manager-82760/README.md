# [Marketing Operations Manager](https://www.remotewlb.com/apply/marketing-operations-manager-82760)  
### Spring Health  
#### `💰 250050.0`  
...
Reporting to the Director of B2B Marketing Operations, the Marketing Operations Manager will collaborate with cross-functional teams to ensure the successful execution of integrated marketing campaigns, the tracking of campaign performance metrics, and be a key contributor to the optimization of our marketing operations processes.

### What you’ll be doing:

  * _Own and manage end-to-end campaign production and execution, including campaign creation, audience segmentation, tracking, campaign delivery, optimization and communication to all stakeholders_
  *  _Create scalable processes that ensure best practices in campaign setup, conversion and database management_
  *  _Manage marketing automation systems to build, deploy and track emails, landing pages, forms, etc._
  *  _Develop and execute inbound marketing strategies and programs that drive large-scale web improvements and lead flow management_
  *  _Own web and CRO/LPO testing to ensure contribution to customer acquisition and pipeline goals_
  *  _Work hand in hand with Demand Generation leads on pre and post event operations including enriching, campaign tagging, list uploading, etc._
  *  _I_ _n partnership with the brand and product teams, ensure web UX is effective, efficient and aligned with brand standards and goals_
  *  _Own relationship with web dev agency_

### What we expect from you:

  * _5+ years of experience in Marketing Operations_
  *  _Technical knowledge of Salesforce and Hubspot_
  *  _B2B company and go-to-market strongly preferred_
  *  _Leadership abilities, collaborative project management skills, and technical knowledge to lead day-to-day campaign operations_
  *  _Strong understanding of conversion rate optimization and a/b/multivariate testing to drive lead generation, pipeline and revenue_
  *  _Strong knowledge with the following: Google AdWords, Analytics, Tag Manager, Data Studio, and Search Console, as well as Website optimization and personalization tools (e.g. Hotjar, Google Optimize, Unbounce), Webflow and SEO tools (SEMRush or similar)_
  *  _Ability and desire to work in a fast-paced, fast-growth environment_
  *  _Proactive approach to project management_
  *  _Experience developing creative solutions to complex problems_
  *  _Strong statistical and analytical skills_

 _The target salary range for this position is $108,700 - $141,350, and is part of a competitive total rewards package including stock options, benefits, and incentive pay for eligible roles. Individual pay may vary from the target range and is determined by a number of factors including experience, location, internal pay equity, and other relevant business considerations. We review all employee pay and compensation programs annually at minimum to ensure competitive and fair pay._
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/marketing-operations-manager-82760)

# [Adobe Experience Manager (AEM) Developer](https://www.remotewlb.com/apply/adobe-experience-manager-aem-developer-64700)  
### dentsu international  
#### `💰 178400.0` `🌎 United States`  
...
This role reports into the Senior Manager of Software Development at Merkle and is a fully remote role.
...
### Job Description
  ...
  * You can design integrations using various marketing technologies.
  * You can translate requirements to both non-technical clients and cross-functionally with internal technical development teams.
  * You can explain cross-browser compatibility issues and approaches.
  * You have the technical proficiency to accurately document code on the front-end via Javascript, HTML, and CSS.
...
### Qualifications
  ...
  * 2+ years of professional hands-on Adobe Experience Manager (AEM) Software Development experience and experience building sites using AEM 6.5+.
  * 4+ years of deep experience in Java development in a professional environment, and proficiency with Sling.
  * 4+ years of experience working with Agile methodologies and iterative development.
  * 2+ years of experience with unit testing, static analysis, and building automation.
  * Strong interpersonal skills such as effective listening, empathy, patience and the ability to interface with customers.
  * Ability to quickly understand technical context in diverse customer environments.
  * Ability to work collaboratively cross-functionally across our organization as well as independently.
  * Ability to adopt an "Embrace the Unknown" attitude by continuing to learn and explore new tools, concepts, and ideas then share them with the rest of the team.
  * Experience with Adobe Experience Cloud, Adobe Experience Manager, and Adobe Analytics preferred.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/adobe-experience-manager-aem-developer-64700)

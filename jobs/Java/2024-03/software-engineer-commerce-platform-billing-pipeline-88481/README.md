# [Software Engineer - Commerce Platform Billing Pipeline](https://www.remotewlb.com/apply/software-engineer-commerce-platform-billing-pipeline-88481)  
### Twilio  
#### `💰 USD 135920.0~169900.0` `🌎 United States`  

### **See yourself at Twilio**

Join the team as Twilio’s next Software Engineer within Commerce Platform Billing Pipeline
...
As a Commerce Platform engineer, you will design and build core platform services, REST APIs and take part in transitioning our platform to next generation architecture. We run on AWS cloud infrastructure and use AWS cloud data store, messaging services SNS, SQS, Aurora RDS etc.
  ...
  * 3+ years of programming experience in Java/Microservices writing clean code.
  ...
  * Experience mentoring engineers and fostering an inclusive environment, where all points of view are welcomed and encouraged.
  * Experience building scalable software including distributed systems infrastructure, business logic for APIs or tooling to help debug mission critical applications.
  ...
  * Good knowledge of relational databases(Aurora/MySQL, DynamoDb etc) , Sharding, SQLqueries optimizations and ORM technologies.
  * Strong experience in Cloud Solutions AWS, RDS, Kubernetes/EKS, CI/CD pipelines, Testing Automation mindset 
...
### Desired:
  ...
  * Good understanding of AWS infrastructure or other public cloud providers
  * Experience managing Devops infrastructure.
  * Good debugging skills on production systems.

### Location

  1. This role will be remotebut is not eligible to be hired in San Francisco, CA, Oakland, CA, San Jose, CA, or the surrounding areas.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-commerce-platform-billing-pipeline-88481)

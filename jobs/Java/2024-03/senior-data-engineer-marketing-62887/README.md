# [Senior Data Engineer, Marketing](https://www.remotewlb.com/apply/senior-data-engineer-marketing-62887)  
### Circle  
#### `💰 ~195k` `🌎 US,Washington, D.C.,Remote`  
...
As a member of the Data Engineering Marketing team, you own the ETL/ELT pipelines and data warehouse that is used to inform Marketing strategy, evaluate campaign performance, optimize traffic on Circle’s publicly facing websites and engage with external Web3 developers.
...
**What you'll work on:**
  ...
  * Working closely across groups, such as the product, engineering, data science, marketing, and web3 teams, for data modeling, general management of data life cycle, data governance and processes for meeting regulatory and legal requirements.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-data-engineer-marketing-62887)

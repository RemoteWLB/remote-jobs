# [Intermediate Data Engineer](https://www.remotewlb.com/apply/intermediate-data-engineer-74030)  
### Employment Hero  
#### `🌎 Vietnam`  
...
We are now looking foran _ **Intermediate Data Engineer**_ who will play a critical role in

  * Design, develop, and maintain scalable and robust data pipelines to ingest, transform, and deliver data from various sources into our analytics platforms.
  * Collaborating with data scientists, analysts, and system owners to understand their data needs and requirements, and to ensure that data is available and accessible in the right format and at the right time.
  * Design data models to meet the analytics requirements..
  * Building and managing data warehouses that store and manage large volumes of data, looking for opportunities to optimise performance, stability, cost, and reliability.
  * Monitor and drive data quality and consistency. Including data validation data cleaning, setting up monitoring and logging systems, and notifying source system owners where appropriate.
  * Apply and promote best practices for code maintainability and performance. Documenting and keeping up-to-date technical and analytical knowledge to share between teams.

### Requirements

### You’re the hero we’re looking for if:

  * 3+ years experience as Data Engineer or similar role
  * Proficiency in using either Python, Java or Scala for data processing (Python preferred).
  * Advanced understanding of SQL and analytical data warehouses.
  * Strong data modelling skills.
  * Hands-on experience building, troubleshooting, optimising and monitoring data pipelines.
  * Hands-on experience with ETL tools such as Fivetran, Airflow, DBT.
 ...
 **Nice to have skills/ experiences (but not required to be considered):**
  ...
  * DevOps practices and tools for the deployment and management of data infrastructure, like Infrastructure as Code (Terraform), Github Actions, Docker.
  * AWS Cloud Certificate.
  * Independent proactive remote working experience.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/intermediate-data-engineer-74030)

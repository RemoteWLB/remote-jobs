# [Staff Software Engineer](https://www.remotewlb.com/apply/staff-software-engineer-121384)  
### Twilio  
#### `🌎 Remote - Estonia`  

**See yourself at Twilio**

Join the team as Twilio’s next Staff Software Engineer for Video and Voice: two of the key communications channels for Twilio’s customers.
...
This position is needed to build out a new team to enable Twilio to better support our global customers using Video and Voice in their solutions. As a Staff Engineer on this team you will participate in all phases of the software development life cycle which includes requirements gathering with Product Managers, technical design, estimations, sprint planning, coding, testing, deployments and on-call support. This engineer will own, operate and maintain their teams’ services in a distributed production environment, employing Agile methodologies to continuously deliver value to customers. In addition you would mentor more junior members of the team.
...
**Required:**
  ...
  * Able to demonstrate proficiency in at least one language, web stack and framework
...
**Desired:**
  ...
  * Knowledge and experience working with the webRTC protocol 
  * Knowledge and experience working with SIP protocol

**Location**

This role will be based in our Tallinn, Estonia office, or remote in Estonia.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-engineer-121384)

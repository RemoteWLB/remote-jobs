# [Senior Software Engineer (Backend)](https://www.remotewlb.com/apply/senior-software-engineer-backend-120480)  
### Raft Company Website  
#### `💰 $110,000 - $200,000` `🌎 Remote, US`  
...
As a **Senior Software Engineer** , you will be part of the team building a data focused product that is built on best of breed open source solutions like Kafka, Trino, DuckDB, and Superset. You will primarily work both on backend and infrastructure to build end-to-end features that make interacting with data easier enabling users to be able to tell a data story through our product.

**What we are looking for:**

  * 4+ years of hands-on experience building RESTFul APIs to take concept to implementation in one of the following languages: Java, Scala, Python, Rust, Go

  * At least 1 year of experience in Data Intensive applications ranging from low latency high throughput (Kafka), Lakehouse Architecture (Delta Lake), JDBC (PostgreSQL)

  * Deep design of software design and architecture

  * Experience / Interest in DuckDB and building data focused projects that tell a story
...
**Work Type:**
  ...
  * Remote (Local to Tampa, FL preferred)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-backend-120480)

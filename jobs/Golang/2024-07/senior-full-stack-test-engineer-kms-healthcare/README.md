# [Senior Full-stack Test Engineer, KMS Healthcare](https://www.remotewlb.com/apply/senior-full-stack-test-engineer-kms-healthcare)  
### KMS Technology  
 ...
 **General requirements:**
  ...
  * Likely having 3+ years of experience in a similar role
 ...
 **Technical requirements:**
  ...
  * Strong experiences on manual testing (requirement analysis, test strategy, test approach, test plan, test techniques included black box, risk-based, exploratory, Non-UI testing, etc.)
  * Experience on Automation testing, API testing
  * Experience on using technologies and frameworks: Playwright, Cypress, Selenium, Appium, WebDriver, TestNG, JUnit, Cypress
  * Experience on using programming languages: JavaScript and/or other programming languages
  * Experience on using tools: Postman, Git, IntelliJ IDEA...

 **Nice to have:**

  * Experience on Performance and Security testing
  * Experience on CI/CD
  * Experience on building frameworks
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-full-stack-test-engineer-kms-healthcare)

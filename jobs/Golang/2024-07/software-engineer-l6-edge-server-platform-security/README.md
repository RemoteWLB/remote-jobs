# [Software Engineer L6 - Edge Server Platform Security](https://www.remotewlb.com/apply/software-engineer-l6-edge-server-platform-security)  
### Netflix  
...
A small team of talented software engineers develops and maintains the operating system that runs the content caches. Because of the important role these caches serve, it is critical that they be both efficient and secure.
...
* Experience using operating system execution environments such containers or virtual machines to enhance security
...
* Experience conducting penetration tests which found meaningful opportunities for improvement and identify security gaps.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-l6-edge-server-platform-security)

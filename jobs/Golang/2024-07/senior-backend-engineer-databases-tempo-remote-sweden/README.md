# [Senior Backend Engineer - Databases, Tempo (Remote, Sweden)](https://www.remotewlb.com/apply/senior-backend-engineer-databases-tempo-remote-sweden)  
### Grafana Labs  
#### `🌎 Sweden (Remote)`  
...
We are the developers of Tempo, an open source distributed tracing backend that is user-friendly, scalable, and a key component of Grafana Enterprise Traces (GET). Tempo allows users to easily search for traces, create metrics from spans, and connect tracing data with logs and metrics. Our team, focused on back-end development, collaborates closely with customers and the Grafana Cloud teams to provide Tempo for on-premises use and at scale in the cloud.
...
Tempo is relied upon by prominent global organizations for monitoring critical applications and infrastructure. We value creativity and diverse perspectives, encouraging each team member to contribute ideas that enhance our product as a reliable tool.
...
We are a remote-first organization and meet regularly using video calls and communicate asynchronously through documents. An independent attitude and good communication skills are a must.
...
In the USA, the Base compensation range for this role is SEK 738,000 - SEK 886,000. Actual compensation may vary based on level, experience, and skillset as assessed in the interview process. Benefits include equity, bonus (if applicable) and other benefits listed here.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-backend-engineer-databases-tempo-remote-sweden)

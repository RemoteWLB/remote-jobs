...
Arkadium is seeking an exceptional and experienced senior full-stack software engineer to help support the development of our award-winning games.
...
_While this role is remote, candidates must be available to work standard hours from 09:00 to 18:00 in the Western European Time (WET) zone - (Portugal time zone), where most of the Engineering and Product teams are based._
 ...
 _For candidates not residing in Portugal, you will be onboarded as a_ _ **full-time contractor**_ _through our international payroll provider._
...
### **Requirements**
  ...
  * 7+ year experience as a **web engineer**
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-tools-engineer-remote)

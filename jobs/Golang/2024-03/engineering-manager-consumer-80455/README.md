# [Engineering Manager, Consumer](https://www.remotewlb.com/apply/engineering-manager-consumer-80455)  
### Coinbase  
#### `💰 423000.0` `🌎 Canada`  
...
We are looking for an Engineering Leader to join Trust & Loyalty to lead a brand new team focused on high net worth individuals (HNW). This new team will work very closely with the broader Coinbase One (CB1) team.
...
As an Engineering Manager of the HNW team, you'll play a pivotal role in creating unique experiences and value to our customers that drive the largest revenue for Coinbase (think elevated in-app delight to white-glove services such as account managers & VIP support). You’ll work closely with your product partner to define a business, product, and engineering strategy to launch + scale this brand new effort.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/engineering-manager-consumer-80455)

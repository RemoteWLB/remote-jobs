# [Principal Software Engineer – IaaS (Cluster Management) (REMOTE)](https://www.remotewlb.com/apply/principal-software-engineer-iaas-cluster-management-remote)  
### GEICO  
#### `💰 ~204k` `🌎 US,Remote`  
...
**Experience**
  ...
  * 6+ years in IaaS/PaaS software development, specializing in the Kubernetes cluster management using some cloud platform.

  * 4+ years of hands-on experience in open-source frameworks.

  * 3+ years dedicated to architecture and design.

  * 3+ years working with AWS, GCP, Azure, or other cloud services.

  * 1+ years leadership experience leading cross functional technical team.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/principal-software-engineer-iaas-cluster-management-remote)

# [Sr Backend Engineer - O11y, Asserts (Remote, EMEA)](https://www.remotewlb.com/apply/sr-backend-engineer-o11y-asserts-remote-emea)  
### Grafana Labs  
#### `💰 ~0k` `🌎 EMEA,Remote`  

**This is a remote opportunity and we would be interested in applicants from Sweden only at this time.**
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/sr-backend-engineer-o11y-asserts-remote-emea)

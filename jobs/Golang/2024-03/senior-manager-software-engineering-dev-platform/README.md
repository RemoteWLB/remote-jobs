# [Senior Manager, Software Engineering - Dev Platform](https://www.remotewlb.com/apply/senior-manager-software-engineering-dev-platform)  
### New Relic  
#### `💰 ~0k` `🌎 Remote,US,Ontario,Europe,Hyderabad, India,India,Remote Hybrid`  

Description

Senior Manager, Software Engineering - Dev Platform
...
The Developer Platform organization is looking for a Senior Software Engineering Manager to join our group in India. This organization develops and maintains the end-to-end internal CI/CD tooling platform, multi-cloud infrastructure provisioning and fleet management, cloud secrets and identity management controls, infrastructure compliance and audit reporting, and all processes and controls that enable New Relic’s fleet of engineers to effectively release our products to customers. Developer Platform teams work across all engineering and cloud platform teams to implement critical multi-cloud infrastructure projects to support our business.

  
Our Engineering Managers are a select group of technology leaders and mentors who shape the solutions we bring to the market and foster an inclusive environment that brings out the best in people. If you have a strong technical background but you are also a person with great mentoring skills and that knows how to collaborate with multiple teams to ship great software, we would like to hear from you.

What you'll do

  * Work with a team of engineers to design, build, implement and manage secure, scalable and reliable cloud based infrastructure and tooling to support the New Relic Product Platform portfolio.
  * Driving and contributing to the software architecture, and design of our existing\current large-scale distributed systems and new systems we are investing in.
...
This role requires
  ...
  * 6+ years experience with (CI/CD) tools such as Jenkins, Ansible, Travis CI, Circle CI 
...
Bonus points if you have
  ...
  * Experience with containerization tools- Kubernetes, Istio, Cluster API, Crossplane, etc.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-manager-software-engineering-dev-platform)

# [Senior Software Engineer - Identity and Access Management, Trust](https://www.remotewlb.com/apply/senior-software-engineer-identity-and-access-management-trust)  
### Square  
#### `💰 ~223k` `🌎 US,Remote,San Francisco, CA`  
...
Cash App has grown rapidly to 70+ million users moving billions of dollars daily. To support this, we are building out Trust — a new Platform organization responsible for product experiences aimed at promoting the integrity of the increasingly complex Cash App ecosystem. Trust works to improve Cash App access for our customers, while limiting access for bad or unauthorized users by detecting and preventing improper use across all of our core product areas. The teams under Trust creating these mission critical services and products include Identity, Access, Risk Controls and Support Product.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-identity-and-access-management-trust)

# [Software Engineer, Payments](https://www.remotewlb.com/apply/software-engineer-payments-74043)  
### Chainlink Labs  
#### `🌎 Canada`  
...
As a software engineer on the Payments team, you will develop highly impactful products that streamline how we interact and operate the Chainlink ecosystem as we scale across many products and many chains. You will work closely with all functions at Chainlink, from engineering, operations, finance, and marketing to build smart contract driven products end to end. You will work alongside 5-7 other engineers and report the engineering lead on the team.  

### Your Impact

  * Design and own the delivery of large components of the economic protocols powering the Chainlink ecosystem
  * Work closely with fellow engineers to build the end to end experience for your products, which range from dApps, data services, smart contracts and more
  * Work closely with operations to ensure smooth deployment and management of products
...
### Requirements
  ...
  * Experience owning month long projects, including communication of progress, dependencies, and risk mitigation directly with stakeholders and partners
...
### Desired Qualifications
  ...
  * Experience in Solidity, TypeScript, React, SQL, Golang
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-payments-74043)

# [Group Product Manager - Fraud](https://www.remotewlb.com/apply/group-product-manager-fraud)  
### Cloudflare  
#### `🌎 United States`  
**About Us**
...
Cloudflare provides a turnkey Bot Management solution that protects customers from unwanted automated traffic. As attackers have evolved, more sophisticated attacks that specifically target high value endpoints (like login, account creation, or checkout pages) involve humans working in conjunction with automation. We are hiring an experienced Product Manager both to help us launch a new product directly targeted at solving these fraud use cases, as well as helping lead a team or product managers working to improve our existing bot management offerings.

As Group Product Manager for Fraud, your job will be to:

  * Ensure customers are able to easily identify whether behavior is coming from valid users, or threat actors that have compromised user accounts.
  * Build innovative solutions to customers’ application security problems that leverage the unique strengths of Cloudflare: a massive, highly interconnected network spanning the world, threat intelligence distilled from an unparalleled vantage point on the Internet, and a high-velocity engineering organization that ships early and often.
  * Harness cutting edge machine learning (ML) techniques to build solutions that detect and mitigate application security threats with minimal customer involvement.
...
As a member of the growing team of product managers your responsibilities include:
  ...
  * Be an expert on the domain, the market, the trends. Evangelize the vision constantly so all stakeholders are aligned, have context and understand where we are going.
...
You are entrepreneurial-minded and thrive in a fast-paced and goal-driven environment. You have outstanding communication and collaboration skills and are able to work with a diverse group, get consensus, and drive the product forward. You are execution focused and emphasize getting things done while paying attention to important details. You have several years of experience working with enterprise, SaaS, or security technologies. You have a passion for building SaaS products and want to solve the problems of performance, security, and reliability of the Internet.
  ...
  * 4+ years of experience in product management or solutions engineering
  * 2+ years of experience working directly with customers on security products
  * 2+ years of software engineering or software deployment experience preferred
  * The ability to work in a fast-moving and ever-changing environment
  * 2+ years of product management or equivalent experience with demonstrated ability to discover opportunities, and then define and deliver products.
...
#### **Bonus Points**
  ...
  * Theoretical and practical knowledge of how the Internet works at layers 1 through 7.
  * Direct experience solving translation or account fraud.
  * Experience in Bot Management or distinguishing automated from valid user traffic.
  * A solid understanding of RESTful API design & documentation.
  * Experience developing pricing for new enterprise SaaS products.
  * Scripting/programming experience (Python, Go, etc.) and familiarity with data analysis tools (eg SQL, pandas).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/group-product-manager-fraud)

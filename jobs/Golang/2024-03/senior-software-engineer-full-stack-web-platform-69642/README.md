# [Senior Software Engineer, Full-Stack - Web Platform](https://www.remotewlb.com/apply/senior-software-engineer-full-stack-web-platform-69642)  
### Samsara  
#### `💰 275925.0` `🌎 Canada`  
...
Our team is currently staffed with several senior engineers along with one staff engineer. There are plenty of experienced folks to learn from. We’re looking for an experienced full-stack engineer who has a strong interest in front-end development to come join us!
...
### In this role, you will:
  ...
  * Build upon skills and knowledge across a range of technologies such as Go, GraphQL, Typescript, React, and MySQL. Due to the nature of the role, previous experience with React is required, but experience with the other technologies is not required
...
### Minimum requirements for the role:
  ...
  * You have 4+ years of experience working professionally with modern development practices
  * You have knowledge of designing, architecting, and developing applications using modern JavaScript technologies like React and Typescript
  ...
  * At this time we are only looking for candidates in Canada
...
### An ideal candidate also has:
  ...
  * Experience with packaging systems (ex: Webpack), frontend testing frameworks (Jest, Enzyme, etc.), linting tools (ESLint, Prettier, etc.), Git, and Storybook
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-full-stack-web-platform-69642)

# [Principal Site Reliability Engineer (Reliability)](https://www.remotewlb.com/apply/principal-site-reliability-engineer-reliability)  
### Expel  
#### `💰 ~236k` `🌎 Remote`  

Description

Your passion for uptime was forged deep within Fires of Production and tempered on the Great Anvil of Incident Response. You’re an Expel Principal Site Reliability Engineer - a protector, champion, and leader of Expel's reputation for service reliability. Expel’s mission is to stop evil hackers, and since hackers don’t take downtime, neither can Expel.
...
## **What Expel can do for you**
  ...
  * Provide you a mission you can get behind: stopping evil hackers so our customers can focus on their business and leave their cybersecurity to us
...
Here’s our 4-stage process for this position (5.5 hours total interviewing time):
...
The base salary range for this role is between $163,30 USD and $236,800 USD + bonus eligibility and equity.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/principal-site-reliability-engineer-reliability)

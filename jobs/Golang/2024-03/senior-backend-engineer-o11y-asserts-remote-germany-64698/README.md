# [Senior Backend Engineer - O11y, Asserts (Remote, Germany)](https://www.remotewlb.com/apply/senior-backend-engineer-o11y-asserts-remote-germany-64698)  
### Grafana Labs  
#### `💰 227506.0` `🌎 Germany`  
...
In Germany, the Base compensation range for this role is EUR 103,412 - EUR 124,094. Actual compensation may vary based on level, experience, and skillset as assessed in the interview process. Benefits include equity, bonus (if applicable) and other benefits listed here.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-backend-engineer-o11y-asserts-remote-germany-64698)

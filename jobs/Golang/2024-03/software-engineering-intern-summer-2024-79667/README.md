# [Software Engineering Intern - Summer 2024](https://www.remotewlb.com/apply/software-engineering-intern-summer-2024-79667)  
### Juniper Networks  
#### `💰 ~83k` `🌎 Remote,US`  
...
We’re looking for people who are excited about building and optimizing infrastructure that global businesses rely on -- robust, high-performance software. Our environment is highly collaborative, fostering learning and teamwork, and encouraging all Junivators to take ownership of our collective success.

Our software engineers work up and down the stack, from UI to protocol communications. For our software roles, we generally look for at least one of the following:

  * Strong programming fundamentals, including algorithms and data structures
  * Proficiency in programming languages such as Golang, Python, JavaScript, C++, and/or C
  * Understanding of operating systems and/or computer networking concepts 
  * Understanding of Cloud SaaS application solution and deployment on AWS

For some of our projects, expertise in one or more of the following may be relevant:

  * Cloud software concepts (e.g. on AWS)
  * Kubernetes, Docker
  * Linux 
  * REST API
...
Minimum Salary: $54,450.00

Maximum Salary:$83,490.00

The pay range for this position is expected to be between $54,450.00 and $83,490.00/year; however, the base pay offered may vary depending on multiple individualized factors, including market location, job-related knowledge, skills, and experience. The total compensation package for this position also includes medical benefits, 401(k) eligibility, vacation, sick time, and parental leave. Additional details of participation in these benefit plans will be provided if an employee receives an offer of employment.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineering-intern-summer-2024-79667)

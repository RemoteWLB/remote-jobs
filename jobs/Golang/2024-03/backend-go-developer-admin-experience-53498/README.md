# [Backend Go Developer, Admin Experience](https://www.remotewlb.com/apply/backend-go-developer-admin-experience-53498)  
### 1Password  
#### `💰 272000.0` `🌎 Canada,United States`  
...
Admin Experience is right at the heart of 1Password’s B2B experience, providing an Administrative Console that empowers business leaders to seamlessly integrate 1Password into their organizations, fostering a happy, secure web experience for their teams. The Admin Experience Team is dedicated to building a smart & performant Console that delights our customers, and unlocks other teams to build new functionality, policies, and admin controls. We have a lot of exciting projects on deck like adding backend services to encapsulate data, adding message queues to support automated tasks, and enhancing our permissions model to provide more granular access control.  
This is a remote opportunity within Canada and the US.

### What we're looking for:

  * Strong programming skills in Golang
  * An understanding of web services and RESTful API design
  * Familiarity with MySQL, Redis, or AWS
  * Proficiency in data modeling and querying
  * A security-first approach to development
  * Someone who values autonomy and enjoys space to make your own decisions
  * A healthy balance of being able to work collaboratively while also taking responsibility for assigned tasks
  * Demonstrated ability to concisely communicate complex technical problems and propose iterative solutions
  ...
  * Experience shipping quality software quickly, focusing on customer value and iteration
...
### Bonus points for:
  ...
  * Experience building permission-based access control models
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/backend-go-developer-admin-experience-53498)

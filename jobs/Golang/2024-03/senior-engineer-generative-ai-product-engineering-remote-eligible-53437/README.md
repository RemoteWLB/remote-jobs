# [Senior Engineer - Generative AI Product Engineering (Remote Eligible)](https://www.remotewlb.com/apply/senior-engineer-generative-ai-product-engineering-remote-eligible-53437)  
### Capital One  
#### `💰 ~199k` `🌎 Chicago, IL,Atlanta, GA,San Francisco, CA,McLean, VA,Boston, MA,US,Remote,Plano, TX,New York, NY,Richmond, VA,Richmond, CA`  

Description

130 5th Ave (22130), United States of America, New York, New York
...
**_Preferred Qualifications:_**
  ...
  * Familiarity with Graph or Network Theory and Graph ML, including relevant frameworks and libraries such as Deep Graph Learning (DGL) or PyTorch or NetworkX

  * Familiarity with graph querying tools such as Apache Tinkerpop Gremlin, Apache Spark Graphframes, or graph databases.
  ...
  * Experience with optimizing ML algorithms and software implementations for speed, efficiency and resource utilization
...
San Francisco, California (Hybrid On-Site): $174,900 - $199,700 for Senior Machine Learning Engineer
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-engineer-generative-ai-product-engineering-remote-eligible-53437)

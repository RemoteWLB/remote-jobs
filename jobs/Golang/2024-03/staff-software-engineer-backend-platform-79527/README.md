# [Staff Software Engineer, Backend - Platform](https://www.remotewlb.com/apply/staff-software-engineer-backend-platform-79527)  
### Coinbase  
#### `💰 ~0k` `🌎 Remote,India`  
...
**What you’ll be doing (ie. job duties)** :
  ...
  * Architect and develop platform for all LLM use-cases in Coinbase
...
**Nice to haves** :
  ...
  * You’ve worked with Golang, Docker, Postgres, MongoDB or DynamoDB.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-engineer-backend-platform-79527)

# [Senior Full Stack Engineer (Golang)](https://www.remotewlb.com/apply/senior-full-stack-engineer-golang-59859)  
### Insider  
#### `💰 ~0k` `🌎 Ankara, Turkey,Turkey,Remote`  
...
And now? Now we are looking for a Backend Software Engineer who wants to **take their career one step further.** If you think you are one of those people, here you will have the chance to work with **the world's leading brands with Artificial Intelligence & Machine Learning technologies**. Right now, while you are reading this, **we are sending an average of 2.2 billion requests and almost 2 billion instant notifications to more than 450 servers a day**. **On the Artificial Intelligence and Predictive side, we have more than 100 TB of historical data**. We do not wait for jobs or opportunities to come to our feet, we create them. We have now reached **25% of global users**. If all these interests you, read on for more!
...
### A Full Stack Engineer in Insider day in and day out:

  * develops new features, optimizes existing systems and corrects errors,
  * writes highly scalable and easily maintainable code,
  * is proactive with problems and motivated to solve them,
  * observes the general condition of the system and explores opportunities to improve a complex system,
  * prioritizes creating a world-class experience and adopts that quality is better than speed.

### We want you to join us while we are taking a step into the future if you

  * have a Bachelor's Degree from Computer Engineering or similar departments,
  * have experience with **microservices architecture,**
  * have **2-3 years of experience in software development using Golang,**
  * are comfortable with **simultaneous programming,**
  * can design highly available and scalable systems,
  * have experience with **Cloud Platforms (preferably AWS),**
  * have a level of English knowledge where you will not have any problems while analyzing technical documents,
  * like to observe performance,
  * have a desire to be innovative and pioneering.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-full-stack-engineer-golang-59859)

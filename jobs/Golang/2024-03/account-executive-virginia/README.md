# [Account Executive-Virginia](https://www.remotewlb.com/apply/account-executive-virginia)  
### ChargePoint  
#### `💰 142750.0` `🌎 United States`  
...
### Remote - Must be based in the Virginia area

ChargePoint is committed to fair and equitable compensation practices.

The targeted US salary range for roles at this operating level is $47,250 to $95,500. This range represents base salary and does not reflect equity, benefits or variable pay where applicable. Actual base salaries are based on several factors unique to each candidate, including but not limited to skill set, experience, certifications and specific work location.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/account-executive-virginia)

# [Software Engineer (Backend), Cards API](https://www.remotewlb.com/apply/software-engineer-backend-cards-api)  
### Square  
#### `💰 ~223k` `🌎 San Francisco, CA,US,Remote`  
 ...
 **You will:**
  ...
  * Oversee the entirety of your features, including component design, implementation, testing, and roll-out
  * Maintain and promote operational excellence with focus on high reliability, performance and scalability
  * Develop modern APIs for internal and external developers
 ...
 **You Have:**
  ...
  * Experience contributing to small to medium-scale feature releases
  * Problem-solving skills and attention to detail, with the ability to analyze and resolve complex technical issues
  * Interest in collaboration other engineers and cross functional partners

 **Technologies we use and teach:**

  * Java, Golang, Terraform, GraphQL
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-backend-cards-api)

# [Engineering Manager, Consumer](https://www.remotewlb.com/apply/engineering-manager-consumer-75989)  
### Coinbase  
...
We are looking for an experienced engineering manager to lead one of our teams within the Consumer Product Group. Our team is dedicated to building Crypto Derivatives Trading. We just started going live to our customer base with the initial MVP. We have so much more to build towards providing the customer with powerful and effective, yet easy to understand and navigate the complex world of Derivatives and Crypto, by providing the world-class experience along with reliability and security that Coinbase is known for.
...
### What we look for in you (ie. job requirements):
  ...
  * Possess a strong understanding of what constitutes high-quality code and effective software engineering processes, creating an environment that fosters these principles.
  * Build and manage full-stack engineering teams, to guide the development of features, services, and infrastructure across both web and mobile.
...
### Nice to haves:
  ...
  * Had experience leading a product team, and experience in React, React Native, Graphql, Golang, K8, and MongoDB.
  * Built financial, high reliability systems and/or microservice architecture.
  * Experience with Derivatives trading systems.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/engineering-manager-consumer-75989)

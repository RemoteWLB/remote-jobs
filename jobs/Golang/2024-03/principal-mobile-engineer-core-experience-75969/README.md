# [Principal Mobile Engineer, Core Experience](https://www.remotewlb.com/apply/principal-mobile-engineer-core-experience-75969)  
### Reddit  
#### `💰 557000.0` `🌎 United States`  
...
The Core Experience teams are responsible for all the content that shows up on Reddit and enables users to express their true selves through varied content types like posts, comments, video threads, profiles, and much more. Our mission lies at the core of Reddit's success as a platform: we build features that encourage engagement and belonging, enabling better user experiences with rich content and video, enabling smooth and effective content consumption with ML and personalized experiences. This role will enable us to architect our native apps to scale for the next 3-4 years of our growth. You will help establish the right standards in native app development and will help in improving the overall iOS and Android development experience at Reddit. In addition, you will mentor senior IOS and Android engineers across Reddit and will be seen as a go-to person for any challenges on the native app.

As a Principal Mobile Engineer in the Core Experience team, you will be responsible for creating and driving the technical strategy for the user experience of Reddit users. You will have the company-wide scope, impact, and responsibility in shaping the future of native development at Reddit. You will champion the technology selection and best practices in Reddit’s app development. You will lead the way in bringing technical excellence and innovation to Reddit’s native app codebase.
...
### Who You Might Be:
  ...
  * Demonstrated experience with organizational-wide impact building both iOS and Android consumer facing applications at scale, however deep experience in either Android or iOS is acceptable. 
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/principal-mobile-engineer-core-experience-75969)

# [Full Stack Principal Engineer](https://www.remotewlb.com/apply/full-stack-principal-engineer-41597)  
### GEICO  
#### `💰 ~236k` `🌎 US,Remote`  
...
As a Principal Engineer, you will:
  ...
  * Utilize programming languages like .NET, Python, Java, Go, Rust, SQL, and NoSQL databases, Container Orchestration services including Docker and Kubernetes, and a variety of Azure tools and services
  ...
  * Provide input on design and implementation on user interface
  * Provide guidance to development teams on automated testing frameworks such Cypress, Mochito or similar

Qualifications

  * Fluency and Specialization with at least two modern languages such as Java, C++, Python, Go, or Rust including object-oriented design
  ...
  * Experience with JavaScript frameworks such as ReactJS and Angular or other frameworks
  * Experience with continuous delivery and infrastructure as code
  * Fluency in DevOps Concepts, Cloud Architecture, and Azure DevOps Operational Framework
  * Experience in leveraging and scripting languages
  ...
  * Demonstrable experience with integrating systems, automated testing, leading design conversations with both business and technical stakeholders

Experience

  * 6+ years of professional software development experience in both front-end and back-end systems
  * 4+ years of experience in open-source frameworks, automated testing, code management strategies including versioning, code coverage, reusable code
  * 4+ years of experience identifying and resolving software vulnerabilities
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/full-stack-principal-engineer-41597)

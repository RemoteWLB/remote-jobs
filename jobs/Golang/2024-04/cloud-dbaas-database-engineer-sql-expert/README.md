# [Cloud DbaaS Database Engineer - SQL Expert](https://www.remotewlb.com/apply/cloud-dbaas-database-engineer-sql-expert)  
### Intel  
 ...
 **As a Cloud DbaaS Database Engineer – SQL Expert, you will:**

  * Design, develop and maintain database services in a cloud environment.

  * Design, develop and maintain SQL based database systems such as MYSQL, PostgreSQL, MS SQL Server.

  * Perform database design and development.

  * Perform Query and DB Optimization: Optimize database queries for better performance, identify bottlenecks and manage indexing, normalization, and denormalization.

  * Perform database benchmarking and testing.
  ...
  * Perform engineering and/or administering database systems lifecycle (patches, new releases and functionality enhancements).

  * Plan and perform Data Migration and Integration: In scenarios where businesses need to transition from one DBMS to another or integrate data from multiple sources.

  * Ensure the security and compliance of database systems and services, adhering to industry best practices.

  * Troubleshoot and resolve complex technical issues related to SQL based database systems.
...
The candidate must have a Bachelor's degree in Information Technology, Electrical/Computer Engineering or Computer Science or related filed and 7+ years of experience -OR- a Master's degree in Information Technology, Electrical/Computer Engineering or Computer Science or related field and 4+ years of experience -OR- a PhD in Information Technology, Electrical/Computer Engineering or Computer Science or related field and 1+ year of experience in:  

7+ years' experience in below areas:

  * Designing and operating cloud database systems and services

  * Be a subject matter expert in SQL databases (SQL Server, MYSQL, PostgreSQL)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/cloud-dbaas-database-engineer-sql-expert)

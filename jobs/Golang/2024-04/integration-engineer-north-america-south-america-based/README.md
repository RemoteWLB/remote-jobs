# [Integration Engineer (North America / South America based)](https://www.remotewlb.com/apply/integration-engineer-north-america-south-america-based)  
### Chainlink Labs  
#### `🌎 Ciudad de México / Remote`  

#### Integration Engineer (North America / South America based)

Toronto / Remote / Ciudad de México / Remote / Argentina / Remote / Buenos Aires / Remote / Bogotá / Remote / Vancouver / Remote
...
#### Your Impact:
    ...
    * Collaborate with specialty stakeholders to own the end to end integration of Chainlink products including Data Feeds, CCIP, and Automation to new cutting edge blockchains to enable exponential growth of the network
    * Lead viability research to assess compatibility and coordinate integration through chain-specific node development, token bridging, deployments, monitoring, tooling, and testing
    * Work collaboratively with industry leaders, developers, users, and the web 3 community
...
#### Requirements:
    ...
    * Learns quickly and dives deep into code and documentation
    * Professional engineering experience working in a collaborative, product-driven environment
...
#### Desired Qualifications:
    ...
    * 2+ years of experience with software development in one or more programming languages - Golang, Python, C++, and/or TypeScript
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/integration-engineer-north-america-south-america-based)

# [Software Engineer - Backend (Risk - Platform)](https://www.remotewlb.com/apply/software-engineer-backend-risk-platform-57785)  
### Coinbase  
#### `🌎 India`  
...
Credit risk platform provides one stop shop to address all the credit and market risk management needs for coinbase across CeFi and DeFi, at scale. We aim to provide real time monitoring, alerting, dynamic data configuration and intelligent decision capabilities for Institutional (Bilateral Lending, Portfolio Margin, Trade Finance) and Retail products (Futures, INTX).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-backend-risk-platform-57785)

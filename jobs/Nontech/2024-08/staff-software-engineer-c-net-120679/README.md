# [Staff Software Engineer - C#/.NET](https://www.remotewlb.com/apply/staff-software-engineer-c-net-120679)  
### Rithum  
#### `💰 $174,000/yr - $235,000/yr` `🌎 Ireland - Remote`  
...
Primary Technologies
  ...
  * Http Api, OpenApi
  * Xunit and Moq
  * Unit and Integation tests, understand differences and when to use them
  * IoC
  * NET Core, minimal Api
  * Net 7+ and Net framework 4.8
  * Specflow test framework
  * IaC, Kustomize, AWS Cloud Formations
  * AWS (S3, EKS, Elasticache (Redis))
  * AzureDevOps Pipeline and Releases
  * Branch strategies in git
...
Minimum Qualifications
  ...
  * A person who can thrive in a highly autonomous and self-directed environment
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-engineer-c-net-120679)

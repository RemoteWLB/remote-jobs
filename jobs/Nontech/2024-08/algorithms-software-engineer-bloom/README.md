# [Algorithms Software Engineer - (Bloom)](https://www.remotewlb.com/apply/algorithms-software-engineer-bloom)  
### Sword Health  
#### `💰 $` `🌎 remote,Porto`  
...
* Work as a part of the Bloom App Software team, designing and implementing algorithms for analyzing the patient’s pelvic floor contractions - enabling the evaluation of exercises with real-time feedback;
* Implement features that include the above algorithms or interact with existing algorithms directly in a large production codebase (Kotlin);
* Write well-designed, efficient, and scalable code that can be deployed across different platforms;
...
* 3+ years of experience in software development, with solid knowledge of design patterns and system design;
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/algorithms-software-engineer-bloom)

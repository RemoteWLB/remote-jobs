# [Senior Frontend Software Engineer | Explore](https://www.remotewlb.com/apply/senior-frontend-software-engineer-explore-80650)  
### Gympass  
#### `🌎 Brazil`  
...
We are hiring a Senior Frontend Software Engineer to our CODE team in Brazil!

Our main goal in CODE is to make wellbeing universal. From knowing about Gympass, getting access to exclusive benefits, to using our vast partner's network, it is in the end-user experience. CODE is an acronym for Consumer Digital Experience, which means we're in charge of the experience and services that will guide people into their wellbeing journey.
...
###  **YOUR IMPACT**
  ...
  * Follow-up engineering and product KPIs.Live the mission: inspire and empower others by genuinely caring for your own wellbeing and your colleagues. Bring wellbeing to the forefront of work, and create a supportive environment where everyone feels comfortable taking care of themselves, taking time off, and finding work-life balance.

###  **WHO YOU ARE**

  * Bachelor's degree in Computer Science, Computer Engineering, or related discipline or equivalent practical experience
  * Solid experience with ReactJS/React Native ecosystem
  * Consolidated experience in mobile development with React Native.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-frontend-software-engineer-explore-80650)

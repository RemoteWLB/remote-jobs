# [Senior Frontend Software Engineer, Host Calendar](https://www.remotewlb.com/apply/senior-frontend-software-engineer-host-calendar)  
### Airbnb  
#### `💰 ~221k` `🌎 Remote,US`  
...
The Host Calendar team is looking for a Senior Frontend Software Engineer to help us craft the next generation of tools for Airbnb hosts. We create tools that help our hosts run their business, giving them insights to help them better price their properties that hopefully lead to better returns. As a Senior Frontend Software Engineer working in the Host Calendar team, you will help create the next generation of tools and features to help hosts run their business day-to-day.

**The Difference You Will Make:**

Collaborate with cross-functional partners such as Experience Designers, Product Managers and Engineers to design and deliver high-quality products on Android. Build efficient and reusable web components and architect reliable, performant, and scalable solutions. Mentor, guide, advocate and support the career growth of individual contributors. Identify areas of improvement and drive best practices.
...
**Your expertise**
  ...
  * 5+ years’ experience developing Web applications at scale with a high volume of users with an eye for visual details
  * Experience with modern Javascript/Typescript libraries, Animation APIs and tooling (e.g. React, GraphQL); Fluency in HTML, CSS, and related web technologies
  ...
  * You’re passionate about continuous learning and innovation in the frontend technology and build web applications with web development best practices
  * Experience with cross-browser compatibility development and testing
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-frontend-software-engineer-host-calendar)

# [Mid-level Frontend Software Engineer | Access Team](https://www.remotewlb.com/apply/mid-level-frontend-software-engineer-access-team)  
### Gympass  
#### `💰 ~0k` `🌎 Remote,Portugal`  
...
We are hiring a **Mid-Level Frontend Software Engineer** to our **CODE** Focus Area, **Access** team in **Portugal!**

CODE is an acronym for Consumer Digital Experience, which means we're in charge of the experience and services that will guide people into their wellbeing journey. Our main goal is to make wellbeing universal. From knowing about Gympass, getting access to exclusive benefits, to using our vast partner's network, it is in the end-user experience. CODE teams are responsible for developing and maintaining Gympass's App, frontend, and backend services, and Design System and work closely with product, UX, and data teams to create an excellent experience for the users of our platform.Our mission as the Access team is to create accessible and efficient ways to allow new members to validate their eligibility and register themselves. We are also responsible to provide features to the member manage their eligibilities and family members.
...
# **YOUR IMPACT**
  ...
  * You can interact with the product team and other business stakeholders in a highly collaborative, agile environment. 
  * You will be accountable for your decisions and possess a high level of ownership over the products you are delivering. 
  * You will take ownership of some key features, perform pull-request reviews, and take part in all the architectural decisions of the squad.
...
# **WHO YOU ARE**
  ...
  * Experienced in implementing prototypes, and practices, and concepts such as MVP, A/B testing, and feature toggles for rolling out features to production;
  * Proficient in a broad range of common UX patterns;
  * Excellent analytical, problem-solving, and critical thinking skills;
  * Strong communication skills both in English and Portuguese;
...
**The following would be considered a plus:**
  ...
  * Experience with Firebase ecosystem (Custom events, remote configs, Crashlytics);
  ...
  * Experience with other component-driven libraries/frameworks and Hybrid Native approach;
  * Experience with Design Systems;
  * Experience with System Integrations;
  * Experience with AWS.  

We recognize that individuals approach job applications differently. We strongly encourage all aspiring applicants to go for it, even if they don't match the job description 100%. We welcome your application and will be delighted to explore if you could be a great fit for our team. For this specific role, please note that prior experience with React.js and Typescript are mandatory requirements.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/mid-level-frontend-software-engineer-access-team)

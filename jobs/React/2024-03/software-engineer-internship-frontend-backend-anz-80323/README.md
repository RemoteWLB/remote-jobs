# [Software Engineer Internship (Frontend / Backend) - ANZ](https://www.remotewlb.com/apply/software-engineer-internship-frontend-backend-anz-80323)  
### Canva  
 ...
 **You're probably a match if**
  ...
  * You are comfortable working in Java and/or Javascript.
  * You have the passion to learn and grow as a technologist.
  * You are able to commit to the 12-week, full-time summer program from early December 2024 to late February 2025.

 _We are welcoming applications for the **Software Engineer Internship** till **21st of April 2024** , only.  
...
We hire based on your strengths. If you are keen to do a Backend-focused internship, you'll be working on a massive distributed backend environment built on Java microservices, hosted on AWS, and utilizing a variety of tools, technologies, services, and libraries. If your interest lies in Frontend technologies, you'll be working on a fat client layer built on Native JavaScript and a React, Mobx, Typescript stack. We've got some nifty bespoke components that create a bit of magic as well!
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-internship-frontend-backend-anz-80323)

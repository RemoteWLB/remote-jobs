# [Frontend Engineer, Growth](https://www.remotewlb.com/apply/frontend-engineer-growth-39316)  
### Whatnot  
...
#### 💻 Role
  ...
  * Growth engineers at Whatnot have big ownership and velocity in order to significantly impact the company top-line metrics. To achieve our goals, we are passionate about understanding our buyer and seller experiences and becoming experts in our business metrics.
  * We always prioritize the highest impact features and ship them quickly. As a frontend engineer on Growth, you will have a lot of freedom to research and find new opportunities to drive the product direction. As a result, it's a fun team to work on!  

  * The breadth of projects are wide as we will work on any project necessary to grow us faster but some sample growth team projects are: features that help new sellers become successful, features that help new users understand and love the product, along with the typical growth products like authentication, activation, email / notifications, SEO, performance marketing, and more.
...
####  **👋 About You**
  ...
  * Mastery of at least one language (we primarily use Python, React, Elixir, JavaScript, and are open to others).
  * You can execute pixel-perfect designs and have a strong knowledge of CSS.
  ...
  * Product Management experience (optional).
  * AWS/DevOps experience (optional).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/frontend-engineer-growth-39316)

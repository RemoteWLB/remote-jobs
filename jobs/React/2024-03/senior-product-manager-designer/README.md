# [Senior Product Manager, Designer](https://www.remotewlb.com/apply/senior-product-manager-designer)  
### Webflow  
...
The Designer team is responsible for the core experience that enables designers to transform their creative visions into reality. As a Senior Product Manager on the Designer team, you will enable visual developers to design and build amazing web experiences with powerful, flexible primitives for styling and structure.
...
###  **About the role**
  ...
  * Reporting into the Director of Product Management, Core

As a Senior Product Manager on the Designer team, you will …

  * Own the vision and roadmap for Webflow’s core visual development capabilities- including styles, interactions, variables, and libraries.
  * Bring the voice of the visual developer to the product development process - developing deep user empathy and combining insights from design and code development
  * Collaborate closely with engineering, design, user research, and GTM teams to bring to life new tools and capabilities
  * Operate at every level of fidelity – sweating the UX details of styling single elements while also pushing to unlock bold new capabilities for sharing components and variables across multiple projects.
...
You’ll thrive as a Senior Product Manager if you:
  ...
  * Have experience in product management, design or related discipline
  * Are excited about empowering builders, designers, and creatives with amazing tools
  * Are familiar with frontend web development - HTML, CSS, Javascript and modern frameworks like React
  ...
  * Can effectively communicate complex topics to a broad range of audiences
...
### **Please note:**
 ...
 _Webflow Applicant Privacy Notice_

  
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-product-manager-designer)

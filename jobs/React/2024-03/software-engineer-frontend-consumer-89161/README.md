# [Software Engineer, Frontend - Consumer](https://www.remotewlb.com/apply/software-engineer-frontend-consumer-89161)  
### Coinbase  
#### `💰 USD 140250.0~165000.0` `🌎 United States`  
...
Coinbase is seeking experienced frontend engineers to join our teams in the Consumer Product Group to build out the next generation of crypto-forward products and features. You will help build the next generation of systems to make cryptocurrency accessible to everyone across the globe.

The Consumer Product Group engineers strive to make the Coinbase apps the easiest-to-use and fastest experience for accessing crypto.

### What you’ll be doing (ie. job duties):

  * Design and implement highly engaging, creative features that attract new users and motivate them to revisit our app every single day
  * Build a mass market interface for web3 content such as NFT minting, Airdrops, dApps, and highlighting trends in cryptocurrencies
  * Build the first ever social layer on top of existing web3 content using third party social graph APIs
  * Work with other engineers, product managers and senior leadership to turn our vision into a tangible roadmap every quarter.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-frontend-consumer-89161)

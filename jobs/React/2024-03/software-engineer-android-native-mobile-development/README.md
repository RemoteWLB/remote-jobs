# [Software Engineer- Android Native Mobile Development](https://www.remotewlb.com/apply/software-engineer-android-native-mobile-development)  
### Legion  
#### `🌎 India`  

### Software Engineer- Android Native Mobile Development

###  **Bangalore, India - Remote**

### Job Description

We are looking for a mobile app developer responsible for the development and maintenance of applications aimed at a range of iOS and Android devices including mobile phones and tablet computers. Your primary focus will be development of native iOS and android applications and their integration with back-end services. You will be working alongside other engineers and developers working on different layers of the infrastructure. Therefore, a commitment to collaborative problem solving, sophisticated design, and the creation of quality products is essential.

###  **Responsibilities**

  * Mobile App Development: Design and develop Android applications using Java or Kotlin, with a focus on integrating WebView components.
  * WebView Integration: Expertise in integrating and customizing WebView components for seamless web content display within native applications.
  * Hybrid App Development: Develop hybrid mobile applications that combine native functionality with web-based content.
  * Code Optimization: Optimize WebView-based components for performance and efficiency.
  * Collaboration: Collaborate with cross-functional teams to ensure the successful integration of web content into native applications.
  * Bug Fixing and Maintenance: Identify and resolve issues related to WebView implementation, and provide ongoing support and maintenance.
  * UI/UX Implementation: Implement and maintain user interfaces, including WebView layouts, based on UI/UX designs.
  * Code Review: Participate in code reviews to ensure the quality and compatibility of WebView components with the overall application.
  * Testing: Write and execute tests specific to WebView components to ensure their reliability and compatibility.
  * Stay Updated: Keep up-to-date with the latest developments in Android WebView technology and web standards.

### Requirements Skills

  * Education: Bachelor's degree in Computer Science, Software Engineering, or a related field.
  * Experience: 4+ years of Proven experience as an Android Developer with a focus on integrating WebView components.
  * Programming Languages: Proficient in Java or Kotlin for Android app development.
  * Android Framework: Strong understanding of the Android SDK, WebView, and relevant libraries.
  * WebView Expertise: Demonstrated expertise in integrating and customizing WebView components for Android applications.
  * Version Control: Experience with version control systems, such as Git.
  * UI/UX Knowledge: Familiarity with UI/UX design principles and the ability to implement designs for WebView.
  * Problem Solving: Strong problem-solving and debugging skills, especially related to WebView issues.
  * Communication: Good communication skills and the ability to collaborate effectively in a team environment.
  * Adaptability: Ability to adapt to new technologies, especially in the context of WebView integration.

### Additional Skills (Preferred):

  * Experience with either of IOS native development, React JS or Server side experience with Java based
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-android-native-mobile-development)

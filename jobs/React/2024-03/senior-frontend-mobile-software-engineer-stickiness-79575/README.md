# [Senior Frontend-Mobile Software Engineer | Stickiness](https://www.remotewlb.com/apply/senior-frontend-mobile-software-engineer-stickiness-79575)  
### Gympass  
#### `🌎 Brazil`  
...
We are hiring a **Senior Frontend/Mobile Engineer** for our **CODE** **team - Stickiness Squad** in Brazil!

CODE is an acronym for Consumer Digital Experience, which means we're in charge of the experience and services that will guide people in their well-being journey. Our main goal in CODE is to make well-being universal. From knowing about Gympass, and getting access to exclusive benefits, to using our vast partner's network, it is in the end-user experience.
...
Our mission as Stickiness Squad is to make the users stick on the Gympass Services. So, we are constantly doing experiments to engage the users. Also, we are working closely with health data platforms (like AppleHealth and Google Health) to have a simple way to access and share user health data across the Gympass ecosystem.
...
###  **WHO YOU ARE**
  ...
  * Consolidated experience in web/mobile development
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-frontend-mobile-software-engineer-stickiness-79575)

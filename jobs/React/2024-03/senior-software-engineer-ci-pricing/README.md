# [Senior Software Engineer, CI & Pricing](https://www.remotewlb.com/apply/senior-software-engineer-ci-pricing)  
### dbt Labs  
#### `💰 ~181k` `🌎 US,Remote`  
...
The cloud app group at dbt Labs builds and maintains dbt Cloud, our flagship product. We work across the stack — spanning scalable, distributed backend systems, modern and performant front end client code, robust APIs, auth, permissions, user and plan management, integrations, and more. We have a very exciting roadmap ahead of us, and are looking to add a driven Senior Software Engineer to the team!

We value a collaborative and highly iterative environment. We like to ship code — early and often. We listen to our customers — and adapt to change so we can best deliver value. As a Senior Engineer on the team you will prioritize and tackle problems as they arise. Project specifics may vary, but may include: developing features for customers, strengthening APIs, and implementing new systems end to end. There will also be opportunities to mentor and guide less senior engineers, fostering a learning environment that encourages innovation and technical excellence.

**In this role, you can expect to:**

  * Build backend services in Python and/or frontend code in React
  * Champion industry best practices to help scale and maintain what the team creates
...
**You are a good fit if you:**
  ...
  * Are Adaptable, able to navigate significant project direction or business objective changes
  * Value interacting with end-users and understanding their needs
  * Find success working asynchronously as part of a fully-remote, distributed team

**You'll have an edge if you:**

  * Have prior Pricing and Packaging experience
  * Strong understanding of CI
  * Work pragmatically
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-ci-pricing)

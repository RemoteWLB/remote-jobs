# [Frontend Software Engineer | GPS](https://www.remotewlb.com/apply/frontend-software-engineer-gps-49152)  
### Gympass  
#### `🌎 Brazil`  
...
We are hiring a Mid-Level Frontend Software Engineer to our Billing and Payments | GPS team in Brazil!

The **Billing and Payments** team, located at the **Gympass Platform Services (GPS)** area, is responsible for the platform that serves the entire Gympass business, processing millions of transactions for users and companies around the globe. We work closely with cross functional teams and payment service providers to deliver optimum checkout conversion rates and also efficient account management interactions.

We are looking for a **mid-level frontend software engineer** , with a solid history of quality projects delivered, hands-on technical work, willing to work with a team of ~5 mid-level and senior software engineers working from Brazil.

### **YOUR IMPACT**

  * Research and execute strategic projects along with your team. Your deliverables influence B2B and B2C checkout conversion around the globe, by both creating new payment mechanisms and improving/maintaining existing ones;
  * Implement and deliver solutions working with a cross-functional team;
  * You will also have opportunities to develop engineering skills by getting involved in scalability problems, system architecture, code quality assurance, among others;  

  * Live the mission: inspire and empower others by genuinely caring for your own wellbeing and your colleagues. Bring wellbeing to the forefront of work, and create a supportive environment where everyone feels comfortable taking care of themselves, taking time off, and finding work-life balance.

### **WHO YOU ARE**

  * Focused on making things right and better at every opportunity;
  * Experienced in developing front-end based on RESTful APIs, collaborating with back-end teams to create mocks, define payloads and follow the HTTP best practices;
  * Experience with the ReactJS ecosystem. However, candidates with knowledge in Angular or Vue are welcome;
  * Experience with automated, unit, and behavioral testing of react components;
  * Experience in implementing prototypes and in practices and concepts such as MVP, A/B testing, and feature toggles for rolling-out features to production;
...
We recognize that individuals approach job applications differently. We strongly encourage all aspiring applicants to go for it, even if they don't match the job description 100%. We welcome your application and will be delighted to explore if you could be a great fit for our team. For this specific role, please note that prior experience working with ReactJS (web and mobile), developing frontend based in RESTful APIs and testing are mandatory requirements.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/frontend-software-engineer-gps-49152)

# [Senior Software Engineer Frontend | Account Management Team](https://www.remotewlb.com/apply/senior-software-engineer-frontend-account-management-team-51850)  
### Gympass  
#### `🌎 Brazil`  
...
We are hiring a **Senior Frontend Software Engineer** for our Account Management Squad (part of the B2B team) in Brazil!

The Account Management squad is responsible for making the Companies’ experience as smooth as possible while managing the Gympass benefit. It owns and delivers the set of services that relate to managing the Companies’ contracts and accounting. It is also responsible for the whole Gympass for Companies, creating the tools and strategies that enable other squads to develop new features in the mentioned web app.

The B2B tribe is a global tribe with members in Brazil, Portugal, the United States and Spain. Our main user is the HR and we focus on providing the best set of tools to seamlessly integrate Gympass into the company and its employee's life.
...
###  **YOUR IMPACT**
  ...
  * Partner up with the team to make new features on our platform
  * Write maintainable code and tests
  * Face challenges to our approach head-on
...
### **WHO YOU ARE**
  ...
  * An expert in front-end technologies such as React and Typescript;  

  * Experience with BFF using GraphQL;
  * Someone with expertise in CSS-in-JS technologies such as styled-components and emotion;
  * Able to make changes and debug issues with our build process (e.g. using webpack and vite)
  * A team player who can get their point across to technical and non-technical people in English/Portuguese;
  * A believer in automation (be it unit and integration tests, CI/CD, or something else);
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-frontend-account-management-team-51850)

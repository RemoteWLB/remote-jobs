# [Salesforce Engineer - English (m/f/x) onsite or remote (in Germany and Austria)](https://www.remotewlb.com/apply/salesforce-engineer-english-m-f-x-onsite-or-remote-in-germany-and-austria-109152)  
### Scalable GmbH  
...
###  **Job Description**
  ...
  * Join us in a newly created cross-functional team that will build the platform that will enable industry-leading support our next million clients!
  * Work as a Salesforce Engineer and get support from the team to become a Fullstack TypeScript Engineer.
  * Maintain and evolve our Salesforce Service Cloud solution and integration with Scalable backend.
  * Build a client-facing application that guarantees that Scalable’s clients receive world-class customer support in a timely manner even during phases of high-growth or unexpected market events.
  * Create, run and improve microservices as well as frontend code using TypeScript, React and Node.js.
  * Leverage AWS cloud and serverless services to build and run our platform efficiently.
  * Write clean, testable, maintainable and well-documented code and treat security as a first class citizen
  * Work with cutting edge technologies and be part of modern software development practices (e.g. agile and self-managed teams, continuous integration and deployment, test automation, cloud-based infrastructure and tooling)

###  **Qualifications**

  * A university degree in a relevant field of study (Computer Science, Engineering, etc.) or a comparable practical experience.
  * 3+ years of software development experience with Salesforce, especially Service Cloud.
  * Willingness to evolve into TypeScript, React, Node.js fullstack Developer.
  ...
  * Crisp communication skills in English.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/salesforce-engineer-english-m-f-x-onsite-or-remote-in-germany-and-austria-109152)

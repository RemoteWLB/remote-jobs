# [Senior Software Engineer (Frontend), Banking](https://www.remotewlb.com/apply/senior-software-engineer-frontend-banking)  
### Block  
#### `🌎 Remote,New York, NY`  
...
The Banking Web team is responsible for the Banking surfaces across Square, including Square Checking, Savings, Loans and Credit. We build features that support merchants in their pursuit to understand their cash flow and grow their business.

You will:

  * Architect and oversee the migration of our Ember app into React

  * Mentor team on technical best practices and standards

  * Collaborate cross discipline with server engineers, product managers, designers and analytics

  * Work with and influence the larger Web community within Square

  * Foster a culture of inclusion and psychological safety on the team

###  **Qualifications**

You have:

  * Natural curiosity and desire to performant web experiences
...
Technologies we use and teach:
  ...
  * Typescript, React, Ember, Sass, and other web-app frameworks

  * Test frameworks (e.g. QUnit, Mocha, Jasmine)

  * Observability and monitoring tools (e.g. datadog, sentry)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-frontend-banking)

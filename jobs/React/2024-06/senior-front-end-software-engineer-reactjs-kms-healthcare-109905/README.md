# [Senior Front-end Software Engineer (ReactJS), KMS Healthcare](https://www.remotewlb.com/apply/senior-front-end-software-engineer-reactjs-kms-healthcare-109905)  
### KMS Technology  
 ...
 **Technical requirements:**
  ...
  * Experience with web development technologies (HTML5, CSS3, JavaScript/ES6) and front-end frameworks (ReactJS, Angular, VueJS)
  * Experience with NodeJS and NodeJS frameworks (Nest.js, Express.js)
  ...
  * Experience with large-scale web-based applications, setting up CI/CD pipelines and web security issues.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-front-end-software-engineer-reactjs-kms-healthcare-109905)

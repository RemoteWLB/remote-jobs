# [Senior Fullstack Engineer - Infura (DIN)](https://www.remotewlb.com/apply/senior-fullstack-engineer-infura-din)  
### Consensys  
#### `💰 USD $118,000~$209,000` `🌎 CANADA - Remote, LATAM - Remote, UNITED STATES - Remote`  
...
The Decentralized Infrastructure Network (DIN) team is developing the next product evolution for our longtime infrastructure offering Infura. DIN is a permissionless marketplace for Web3 APIs and services.
...
As a Sr. Full Stack Engineer, you will be a creative thinker and a self-starter with a strong commitment to innovation. You will manage development tasks from assignment to production, working with complex codebases and minimizing technical debt. Proficiency in modern JavaScript and crafting maintainable, well-tested code is essential.

**Would be great if you brought this to the role**

**Responsibilities:**

  * Own the delivery of features and deploy them in a continuous deployment environment.
  * Collaborate with product managers, designers, and other stakeholders.
  * Review and test teammates' pull requests.
  * Monitor and support applications and services to maintain uptime.
  * Develop and maintain Web3 applications and smart contracts.
  * Integrate blockchain technologies into existing systems and applications.

**Ideal Experience and Skills:**

  * Proficiency with NextJS, React, Node.js, TypeScript, Tailwind, Vercel, Turborepo, GitHub, SQL, and OpenAPI.
  * Experience in configuring CI/CD systems.
  * Skilled in creating React UI applications from high-fidelity designs.
  * Organized, independent, and self-sufficient.
  * Ability to coordinate daily with team members and solve problems collaboratively.
  * Expert in JavaScript and Node.js, staying updated with the latest back-end technologies and web standards.
  * Experience developing and consuming APIs.
  * Comfort working with Node.js applications and interacting with APIs and database systems (SQL, NoSQL).
  * Experience with Web3 technologies, such as smart contracts, Solidity, and blockchain protocols.

**Nice to Have OR Bonus Points:**

  * Familiarity with blockchain technology and a passion for decentralized technologies.
  * Experience in a true agile environment and start-up culture.
  * A willingness to help out where needed
  * Understanding of the Blockchain and Ethereum ecosystem, with curiosity to learn more.
  * Experience contributing to open-source projects and knowledge sharing.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-fullstack-engineer-infura-din)

# [Fullstack Engineer - .NET / TypeScript / Electron (100% remote-friendly within Poland)](https://www.remotewlb.com/apply/fullstack-engineer-net-typescript-electron-100-remote-friendly-within-poland)  
### Docplanner  
 ...
 **What will you do with us?**
  ...
  * Develop and Maintain Server-Side Applications: Take ownership of the development and maintenance of server-side applications using .NET (C#) and Symfony (PHP). This involves working on both new projects and enhancing existing ones to meet evolving business needs and performance requirements.

  * Design and Implement APIs and Web Services: Design and implement robust APIs and web services. Ensure seamless integration between frontend interfaces and backend systems, providing efficient data exchange and communication.

  * Utilize Vue.js and TypeScript: Leverage the features and capabilities of Vue.js and TypeScript to build modular, reusable, and maintainable frontend components. Utilize TypeScript's strong typing system to enhance code quality, catch errors at compile-time, and improve developer productivity.
 ...
 **You’re a great fit for this role if you are:**
  ...
  * A person that has a constant desire to learn and the ability to learn quickly.
 ...
 **What will help you thrive? If you:**

  * Have more than 4 years of experience working on web applications.

  * Have strong knowledge of TypeScript and its application within frontend frameworks (ideally vue.js).

  * Create visually appealing and user-friendly interfaces.

  * Have strong experience with at least one backend framework (.NET, Symfony, Spring).

  * Are proficient in working with relational databases (e.g., MySQL, SQL Server) and NoSQL databases (e.g., MongoDB).
  ...
  * Nice-to-have: Experience with Electron

 **Bonus Points if you:**

  * Have experience in developing desktop applications with Electron.

  * Have experience working in DevOps Culture.

  * Are familiar with virtualization tools and container orchestration like Docker and Kubernetes. 

  * Have experience in developing healthcare applications. 
 ...
 **Let’s talk money**
  ...
  * For B2B contract: between 15.000 and 20.500 pln net monthly;
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/fullstack-engineer-net-typescript-electron-100-remote-friendly-within-poland)

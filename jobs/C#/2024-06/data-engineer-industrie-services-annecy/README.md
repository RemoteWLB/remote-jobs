# [Data Engineer - Industrie & Services - Annecy](https://www.remotewlb.com/apply/data-engineer-industrie-services-annecy)  
### Sopra Steria  
...
En tant que Data Engineer, vous jouez un rôle clé dans la conception, la mise en œuvre et la gestion de pipelines de données robustes. Vous êtes responsable du développement sur des projets de build et du maintien en condition opérationnelle du Datalake.
...
Vous travaillez autour des technologies .NET, C#, Python, Angular, Spring, PowerBI, Snowflake.

###  **Qualifications**

 ** _Votre profil_ :**

  * Vous êtes diplômé/e d'une école d'Ingénieur ou équivalent, et disposez d'une première expérience significative en ingénierie de la donnée de 4 ans minimum sur une fonction similaire.
  * Vous maîtrisez différentes technologies telles que Python et Snowflake.
  * Vous avez un bon esprit d’analyse et de synthèse, le sens du relationnel, vous êtes polyvalent/e et autonome.
  * Une expérience avec les services cloud (AWS, Azure, GCP) serait un réel atout.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/data-engineer-industrie-services-annecy)

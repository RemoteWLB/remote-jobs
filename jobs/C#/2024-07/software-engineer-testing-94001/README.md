# [Software Engineer (Testing)](https://www.remotewlb.com/apply/software-engineer-testing-94001)  
### Nava  
#### `🌎 remote,Remote`  
...
* 4+ years of professional experience testing 
* Experience architecting an automated testing plan for individual systems and full product experience, including testing tools and rollout plans
* Be able to collaborate cross-functionally and with multiple scrum teams to ensure a robust automated strategy for all relevant types of testing to ensure only high-quality products are delivered with minimal manual overhead
...
* Experience collaborating with infrastructure teams, to build out initial infrastructure and architecture for the automated testing solution while balancing quick-wins with long-term need
* Strong with communicating with stakeholders from a variety of backgrounds to ensure the automated testings strategy is understood and meets project needs
* Experience onboarding a team of automated testing engineers to build out a robust and maintainable automated testing suite
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-testing-94001)

# [Senior Staff Engineer – SRE Data](https://www.remotewlb.com/apply/senior-staff-engineer-sre-data)  
### GEICO  
#### `💰 USD 82k~261k` `🌎 US,Remote`  
...
As a Senior Staff Engineer, you will:
  ...
  * Utilize programming languages such as SQL, C# or other object-oriented languages, Java, JS, Python, PowerShell, various SQL/NoSQL databases and data management tools
  ...
  * Keep abreast of the industry changes, trends, experiments and educate engineering leadership and team on those topics.
...
### Qualifications
  ...
  * Fluency and Specialization with at least two modern languages such as Java, Go, Python
  * Experience with Micro-services oriented architecture and extensible REST APIs and GraphQL
  ...
  * Experience with application monitoring tools and performance assessments: Dynatrace, Thousand Eyes, Influx, Grafana, Application Insights or equivalents
  ...
  * Experience in On-prem or Azure Network (Subscription, Security zoning, etc.)

  * Deep knowledge of Git, CICD and developer tooling across the software development life cycle (task management, source code, building, deployment, operations, real-time communication)

  * Experience in Docker and Kubernetes platform development
  * Experience data and tooling to manage Data Analytics Platform
  * Advance experience with Enterprise Reporting Tool such as Power BI or Grafana
  * Advance experience with developing Data Pipeline, ETL/ELT, utilizing tooling of Big Data Platform, Datalake, Synapse, Airflow, AirByte, Snowflake
  * Understanding of cyber security practices including vulnerability reports (Veracode scans) and remediation
  * Advanced understanding of security protocols and products
  * Experience with Open-Source Framework
  * Advance experience with Enterprise Reporting Tool such as Power BI or Grafana
  ...
  * Experience with relational and non-relational database technologies such as SQL, PostgreSQL, Oracle, COSMOS, NoSQL, Cassandra, MongoDB
  ...
  * Experience with code reviews to elevate the quality of engineering across the organization
...
### Experience
  ...
  * 10+ years of professional software, Data Analytics/ ML Engineering experience
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-staff-engineer-sre-data)

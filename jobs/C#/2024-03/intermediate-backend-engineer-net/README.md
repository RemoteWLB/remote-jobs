# [Intermediate Backend Engineer (.NET)](https://www.remotewlb.com/apply/intermediate-backend-engineer-net)  
### Employment Hero  
#### `🌎 Vietnam`  

### Our mission and where you fit in

 _Our ambitious team at Employment Hero is on a quest to transform employment, making it easier and more valuable for everyone. Our world-class software is the easiest way for small and medium-sized businesses to manage HR, payroll, employee engagement, and benefits._

 _Since our inception in 2014, we've had enormous growth (100% YoY), now serving 300,000 businesses globally, with 2 million+ users on the platform, reaching unicorn status in 2022 - and we have no plans of slowing down._

 _There’s never been a more exciting time to join one of the fastest-growing global unicorns, so let’s see if we could be a match!_
...
But don’t just take it from us, hear from your local heroes: Thao Ta, Head of People and Culture, and Hung Pham, Group Engineer Manager.
...
*Note: We can be flexible between step 1 and step 2 based on the availability of our team and the urgency of this position. 
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/intermediate-backend-engineer-net)

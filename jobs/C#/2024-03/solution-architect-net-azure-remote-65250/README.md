# [Solution Architect (.NET/Azure) - Remote](https://www.remotewlb.com/apply/solution-architect-net-azure-remote-65250)  
### Experian  
#### `💰 ~0k` `🌎 US,Remote`  
 ...
 **Duties:**
  ...
  * Develop POC’s for the technology, frameworks and present it to the tech & product teams.
 ...
 **Technical Requirements:**
  ...
  * Minimum 5+ years of hands-on experience in Data Ingestion, Integration and Transformation
  * Strong experience of ETL/ELT & BI technologies like Azure Fabric, Azure Synapse, Azure Data Lake, Azure SQL, Azure Data Factory (ADF), Azure Databricks, Azure ML, Power BI, App Insights, Data Activator.
  * Expertise in SQL and Python for streaming technologies, pipelines, frameworks like Kafka, EventHub, Azure Stream Analytics
  * Evaluate and recommend new technologies and tools to improve data architecture.
  * Develop and maintain according to Experian data security standards.
  ...
  * Experience with Entity Framework or other ORM’s
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/solution-architect-net-azure-remote-65250)

# [Développeur/se - .Net - Industrie & Services - Clermont-Ferrand](https://www.remotewlb.com/apply/developpeur-se-net-industrie-services-clermont-ferrand)  
### Sopra Steria  
#### `🌎 France`  
...
En rejoignant Sopra Steria Lyon, vous prendrez part à :
...
Dans ce cadre vous remplissez les missions suivantes :
  ...
  * Vous êtes intégré/e à une équipe en charge du développement et de la maintenance de solutions logicielles ;
  * Vous partagez votre énergie contagieuse et votre passion de l’excellence technique au sein de l’équipe ;
  * Vous jonglez entre le développement Angular, .Net, le tout dans un environnement cloud ;
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/developpeur-se-net-industrie-services-clermont-ferrand)

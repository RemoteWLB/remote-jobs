# [Software Engineer I - Fandango](https://www.remotewlb.com/apply/software-engineer-i-fandango)  
### NBCUniversal  
#### `💰 ~0k` `🌎 US,Remote,Orlando, FL`  
 ...
 **Responsibilities:**
  ...
  * Develop, enhance, test, deploy, and maintain back end software and services in accordance with established SDLC practices for applications/APIs written in C#/node.js
 ...
 **Minimum Qualifications:**
  ...
  * A strong understanding of software development practices and principles
  * Practical experience in one or more of the following programming languages
    * JavaScript/Node
    * C#/.NET
    * Java
 ...
 **Preferred / Useful Qualifications:**
  ...
  * Professional experience as a software engineer working in a back end or full-stack capacity
  ...
  * Experience with cloud technologies (AWS, GCP, Azure or similar)
  * Familiarity with software build, release, deployment, and monitoring tools and practices
  * Familiarity with RESTful APIs, microservices, and/or service-oriented architectures

 **Desired Characteristics:**

  * Passionate about software development and high-quality engineering
  ...
  * Takes initiative to solve issues and knows when to solicit help
  * Communicates effectively with peers and colleagues
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-i-fandango)

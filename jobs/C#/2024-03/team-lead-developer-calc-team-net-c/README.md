# [Team Lead Developer - Calc Team (.NET/C#)](https://www.remotewlb.com/apply/team-lead-developer-calc-team-net-c)  
### Deel  
...
As a Team Lead Developer, you are responsible for overseeing and managing a team of Developers in partnership with the Technical Leads to ensure that both you and the team delivers code in alignment with technical standards and Industry best practices. Additionally, you will drive the maintenance and development of the various backend calculation services pertaining to legislative compliance, payroll, and HR, with a strong focus on performance optimization, throughput, and accuracy
...
### Advantages but not essential
  ...
  * Redis or similar in and out of memory caching Azure 
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/team-lead-developer-calc-team-net-c)

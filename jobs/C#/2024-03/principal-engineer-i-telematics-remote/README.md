# [Principal Engineer I- Telematics (REMOTE)](https://www.remotewlb.com/apply/principal-engineer-i-telematics-remote)  
### GEICO  
#### `💰 ~204k` `🌎 US,Remote`  

Description

GEICO is seeking an experienced Engineer with a passion for building high-performance, low maintenance, zero-downtime platforms, and applications in our Telematics organization. Telematics is at the front of insurance innovation and our growing team supports high quality implementations for these cutting-edge products. You will help drive our insurance business transformation as we transition from a traditional IT model to a tech organization with engineering excellence as its mission, while co-creating the culture of psychological safety and continuous improvement.
...
**Position Responsibilities, as a Principal Engineer, you will:**
...
• Identify technical strategies, processes, and best practices for their direct team

• Provide technical architecture and leadership for multiple teams within a domain or medium cross-functional projects

• Utilize programming languages like TypeScript, C++, Java, C# (.Net), Python, and Container Orchestration services including Docker and Kubernetes, and a variety of Azure tools and services
...
• 6+ years of professional software development experience within the .NET/.NET CORE framework (Angular- UI Front End/ C# including object-oriented design-backend)
...
• Fluent in building platform, core framework, and reusable components
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/principal-engineer-i-telematics-remote)

# [Senior Backend Engineer (Node.js/TypeScript)](https://www.remotewlb.com/apply/senior-backend-engineer-node-js-typescript-74099)  
### Deel  
#### `💰 ~0k` `🌎 Remote,LATAM`  
 ...
 **The bits and bytes that you’ll bring to your new team:**
  ...
  * You’re an expert in JavaScript syntax.

  * You’re a database guru! You know the ins and outs of SQL and NoSQL, mainly PostgreSQL and ORM libraries (such as Sequelize)

  * You have a firm understanding of AWS Services such as S3, EKS, SNS and SQS (If you’re a fast learner, knowledge of GCP or Azure would be suitable, too!)
 ...
 **Extra brownie points if you:**
  ...
  * Have experience with serverless app architecture on AWS.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-backend-engineer-node-js-typescript-74099)

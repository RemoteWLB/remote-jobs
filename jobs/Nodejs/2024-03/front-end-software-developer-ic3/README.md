# [Front-End Software Developer (IC3)](https://www.remotewlb.com/apply/front-end-software-developer-ic3)  
### Cint  
#### `🌎 Spain`  
...
As an IC3 senior developer, you are passionate about learning about tech, product, design, and user experience. You have a collaborative mindset backed by excellent communication skills. You’re user-focused and love building great products.  
...
### What We Are Looking For
  ...
  * 3+ years of software engineering experience building web applications using React 
  * Solid CSS knowledge 
  * Experience with Typescript 
  * Experience with REST APIs 
  * Experience building web applications with responsive design 
  * Experience building web mobile applications 
  * Mobile Testing exposure/familiarity 
...
### Bonus Points If You Have
  ...
  * Experience with common design tools such as Figma and Storybook 
  * Accessibility: WCAG 2.0 AA and AAA 
  * Experience using an internal design system 
  * Experience building/contributing an internal design system 
  * Familiarity of different UI Rendering Architectures (SSR, CSR, SSG, ISR)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/front-end-software-developer-ic3)

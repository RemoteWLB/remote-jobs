# [Senior Software Engineer](https://www.remotewlb.com/apply/senior-software-engineer-61804)  
### Vendavo  
#### `🌎 India`  

We are looking for a Senior Software Engineer with deep experience in software development. Our daily bread is technical challenges that require strong problem-solving skills. If you like technical challenges, team spirit and have knowledge of a wide range of technologies, we are looking for you!

### THE OPPORTUNITY

  * Help with overcoming technical challenges and giving new life to both new and as well-used products
  * Help to choose the best tools and libraries to get the job done
  * Cooperate with other team members, product owner, etc.
  * Mentor others, drive technical solutions
  * Be responsible for specific component(s), analyse requirements and provide technical solutions
  * Deep dive to identify failure patterns to resolve problems at their roots 
  * **Have experience in:** Nodejs framework, Git, Docker, Databases (preferably MySQL, Mongodb), AWS, Kubernetes, CI/CD, REST APIs
  * Strong understanding of object-oriented programming concepts, data structures and algorithms.

### THE SKILL SET

  * 5 to 8 years of Experience as a Software Engineer 
  ...
  * Extensive Nodejs Typescript development experience
...
### THE BENEFITS
  ...
  * 12 vacation days in a year in addition to 12 days sick and 3 days casual leave.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-61804)

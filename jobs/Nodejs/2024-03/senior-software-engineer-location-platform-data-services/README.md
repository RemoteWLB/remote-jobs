# [Senior Software Engineer - Location Platform | Data Services](https://www.remotewlb.com/apply/senior-software-engineer-location-platform-data-services)  
### Foursquare  
#### `💰 ~204k` `🌎 US,Remote`  
...
**In this role, you’ll**
  ...
  * Develop and maintain our industry-leading measurement applications
  * Collaborate cross-functionally with teams such as Data Engineering, Infrastructure, and Client Success
  * Help break down product requirements with team product managers into incremental units of delivery
  * A focus on creating experiences that delight our customers
  * Proactively seek out opportunities for improvement in all aspects of your role

**What you’ll need**

  * 3+ years of related experience 
  * Experience with Java, and Ruby, NodeJS express framework as a good plus
  * CS Degree (or similar) or relevant work experience
  * Experience building software in Java, Ruby/Ruby on Rails, or JavaScript
  * Familiarity working within an agile software development cycle
  * Strong creative problem-solving skills
  * Ability to recognize when to ask for help - we encourage our teammates to learn by asking the right questions
  * Knowledge of data structures and the ability to identify trade-offs of proposed solutions
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-location-platform-data-services)

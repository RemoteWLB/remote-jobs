# [Senior Infrastructure Engineer](https://www.remotewlb.com/apply/senior-infrastructure-engineer-83990)  
### American Express  
...
**Responsibilities:**
  ...
  * Manage delivery, support and maintenance of Storage solutions and tools, including day-to-day administration, configuration, provisioning and reclaim of SAN, NAS, Object, Backup, and Software-defined Storage.

  * Drive the framework, development & delivery of automation to deliver routine tasks like provisioning, catalogue, slack-based self-service capabilities, monitoring, web APIs, as well as new capabilities enhancing customer experience, productivity, and overall availability of Storage systems.

  * Manage capacity, performance, reporting and availability of enterprise Storage solutions, including active system monitoring and management.
  ...
  * Deployment and validation of system changes including scheduled and emergency maintenance, patch management and upgrades to Storage infrastructure.

  * Partner to perform due-diligence on new Storage products, architecture, solutions, tools and standing-up of the service offering. Perform operational readiness testing of new platforms, products and changed infrastructure.
  ...
  * Execute Storage infrastructure projects to improve availability, reduce costs and enhance customer experience. Knowledge of ITIL based Storage Infrastructure support processes, including incident, problem, and change management is required.
...
**Experience:**
  ...
  * Around 10 years of proven experience of managing NAS, SAN, MDS, Backups and Object Storage products, including knowledge of hardware deployments, configuration, performance management, and troubleshooting. 

  * 8+ years of core experience with enterprise tools to manage Storage Alerting, Threshold monitoring, Performance, Capacity & Utilization reporting, etc. (e.g. Unisphere, ONTAP, Native GUI, ActiveIQ, Auto-support, OCUM/OPM, iCinga, ServiceNow, PURE1, OneFS, HyperIQ, Helios)

  * 4+ years of experience with Automation, driving development of self-healing and self-service utilities stitched via API integration or front-end GUI interfaces.
...
**Technical Skills/Capabilities:**
  ...
  * Good knowledge of Storage commissioning and decommissioning, Protocols (FC, NFS, CIFS), Hosting & Backup environment, SAN FC/IP Switches, Scripting tools, ServiceNow, etc.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-infrastructure-engineer-83990)

# [DevOps Engineer (SRE)](https://www.remotewlb.com/apply/devops-engineer-sre-38045)  
### Insider  
#### `💰 ~0k` `🌎 Remote,Istanbul, Turkey,Turkey`  
...
And now? Now we are looking for a DevOps Engineer who wants to **take their career one step further.** If you think you are one of those people, here you will have the chance to work with **the world's leading brands with Artificial Intelligence & Machine Learning technologies**. Right now, while you are reading this, **we are sending an average of 6 billion requests and almost 2 billion instant notifications to more than 700+ servers a day**. **On the Artificial Intelligence and Predictive side, we have more than 100 TB of historical data and 2PB+ monthly data transfer**. We do not wait for jobs or opportunities to come to our feet, we create them. We have now reached **25% of global users**. If all these interests you, read on for more!

  

Our Engineers and Software Developers always think with an **innovative perspective,** taking advantage of the inexhaustible power of the digital world. They create **impressive and intelligent products** like a true artist. Our Product and Development teams are located in our Istanbul office, so **we produce and develop the technology we export to the world in our own country**. As Insider, we believe in cooperation and adapting the innovations brought by technology by **acting fast**. We work **closely with other Departments with agile teams, and we are not afraid of getting our hands dirty**. As we said; we do not wait for jobs or opportunities to come to our feet, we create them ourselves.

You can check our Tech Stacks here: https://www.stackshare.io/companies/useinsider

### A DevOps Engineer in Insider day in and day out;

  * oversees end-to-end monitoring processes to ensure the uptime and performance of our cloud infrastructure and applications,
  * installs, configure, and maintain monitoring systems,
  * analyzes monitoring data to gain insights and identify issues,
  * troubleshoots monitoring system issues and resolve them,
  * innovates to improve the performance of monitoring systems.

### We want you to join us while we are taking a step into the future if you:

  * have at least 3 years of DevOps or SRE experience,
  * have a deep knowledge and experience in monitoring cloud infrastructure (AWS) and applications,
  * have experience with monitoring systems (Grafana, Prometheus, ELK Stack, Splunk, etc.),
  * have experience with a programming language (Python, Go, NodeJs, etc.),
  * have experience with Linux and Unix systemsStrong analytical and problem-solving skills,
  * have an excellent teamwork and communication skills,
  * have experience with APM (Application Performance Monitoring) tools,
  * have experience with AWS CloudWatch,
  * have experience developing Slack integrations.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/devops-engineer-sre-38045)

# [Senior Backend Engineer, API and Integrations Platform - EMEA](https://www.remotewlb.com/apply/senior-backend-engineer-api-and-integrations-platform-emea)  
### Ashby  
#### `💰 ~0k` `🌎 Remote,Europe,Belgium,France,Netherlands,UK`  
...
![](https://app.ashbyhq.com/api/images/user-content/4ea5f68e-c33e-4ac9-831a-e732bee4a303/3922bf90-1bd1-4740-a992-6df54abe30a7/image1.png)
...
You should apply if:
  ...
  *  _Happy developers and customers are your happy place._ You care deeply about their experience with the software you build and seek to understand them to empower a great experience.

  *  _You care about the small things._ A mismatched data model, wrong customer configuration, or oddly documented partner API is all that stands between you and complete chaos, and you fear none of it.
  ...
  *  _You’re not afraid to tackle any part of a technology stack._ While this role is primarily backend, you do what’s necessary to successfully deliver a feature, including writing frontend. We’ll provide a supportive environment to do it successfully (e.g., design system, talented frontend engineers).
...
You should not apply if:
  ...
  *  _You like projects to take months to years._ There’s always something new in this role and pragmatism is the name of the game. You’ll cut scope, make tradeoffs, and always be learning.

  *  _You need a company-driven process and structure to get your projects across the finish line._ Sprint planning and well-defined project management processes are things you need or look to others to lead. You’d rather focus on the technical details and challenges.
  ...
  *  _You haven’t led or taken ownership of projects before._ You’re used to working with tech leads and taking on tasks they distribute.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-backend-engineer-api-and-integrations-platform-emea)

# [Senior Back-End Engineer (NodeJS+Typescript+AWS)](https://www.remotewlb.com/apply/senior-back-end-engineer-nodejs-typescript-aws)  
### None  
#### `🌎 Anywhere (LATAM)`  
 ...
 **What you’ll bring to the Team:**
  ...
  *  **Expertise in Backend Development:** \+ 8 years of experience in Back-End Development and strong proficiency in Node.js, TypeScript/JavaScript best practices, along with experience in at least one other server-side language.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-back-end-engineer-nodejs-typescript-aws)

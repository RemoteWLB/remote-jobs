# [Senior Software Engineer II (Mobile + Web)](https://www.remotewlb.com/apply/senior-software-engineer-ii-mobile-web)  
### Spring Health  
#### `🌎 Remote`  

We are looking for a Senior Cross-Platform Engineer to join our team. You will help push forward cross-platform engineering initiatives and growth opportunities on behalf of our mobile and web developers. You will also work as part of a cross-functional pod to find elegant solutions to mental healthcare’s many problems. Additionally, you will help guide the growth of other engineers as a senior member.

**What You’ll be Doing:**

  * Design and expand the capabilities of our Flutter app and web front end built in React with Redux when needed
  * Become a leader in documentation and standards; build docs and automations for better Flutter, Web and API (GraphQL) development
  * Deliver features by working across our stack such as Push Notifications or multi platform flows. 
  * Show initiative in contributing throughout our tech stack when needed
...
What success looks like in this role:**
  ...
  * Deliver all assigned projects on time with high quality with nearly zero oversight after onboarding
...
**What we expect from you:**
  ...
  * Good hands on experience with Flutter and other mobile languages and concepts
  * Understanding of mobile vs web concepts and taking advantage of both platforms strengths (Push notification on mobile for example)
  * Comfortable taking on projects in web frontend React & Redux codebase
  * Understanding of good API and GraphQL design
  * Bonus points for Ruby on Rails (API development)
  * Bonus points for native mobile (iOS or Android)
...
**Please note:** You must wait **60** **days** before re-applying for the same job. Additionally, you can apply to _up to_ three jobs within a rolling **30 day** window. Focus on applying to jobs that are the most suitable match for your talents by carefully reading the overview and qualification information.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-ii-mobile-web)

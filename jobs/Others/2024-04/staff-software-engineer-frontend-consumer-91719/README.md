# [Staff Software Engineer, Frontend - Consumer](https://www.remotewlb.com/apply/staff-software-engineer-frontend-consumer-91719)  
### Coinbase  
#### `💰 USD 211500.0~211500.0` `🌎 Canada`  
...
Come build the definitive membership for crypto! CB1 redefines what it means to be a member of the crypto community by providing an array of unparalleled benefits like zero trading fees, boosted staking rewards, and priority support to members. Our vision is to create the Amazon Prime experience for all Coinbase users, by creating a membership that users can't afford not to get, and becomes a reason users choose Coinbase over all other competitors. As a Staff Software Engineer on our team, you'll play a pivotal role in shaping the future of crypto memberships.
...
### What we look for in you:
  ...
  * You have at least 8 years of experience in software engineering and at least 7 years of experience in developing web apps and shipping user-facing features with JavaScript and modern, component-based JS frameworks like React.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-engineer-frontend-consumer-91719)

# [Staff Software Engineer - IaaS (Hybrid Cloud) REMOTE](https://www.remotewlb.com/apply/staff-software-engineer-iaas-hybrid-cloud-remote)  
### GEICO  
#### `💰 USD 77k~261k` `🌎 US,Remote,Virginia Beach, VA,San Francisco, CA`  
...
Our Staff Engineer works with Distinguished and Senior Engineers to innovate and build new systems, improve, and enhance existing systems as well as identify new opportunities to apply your knowledge to solve critical problems. You will lead the strategy and execution of a technical roadmap that will increase the velocity of delivering products and unlock new engineering capabilities.

The ideal candidate has experience building common integrations in a multi-cloud environment and collaborates closely with Engineering organizations to modernize the way we manage, govern, and support our hybrid cloud infrastructure.
...
As a Staff Engineer, you will:
  ...
  * Play a key role in the adoption of Azure/AWS/Public Cloud offerings in the enterprise, specifically provide guidance and/or recommendations for landing zone Architecture, RBAC, Managed Identity, and network specific requirements

  * Take on-call and operation support

 **Minimum** **Qualifications**  
· Strong experience in developing simple solutions to complex problems, driving our engineering and cloud automation for networking resources such as VNet/Subnet/NSG/Firewall, VWAN, DNS, and Infoblox across multiple clouds (Azure/AWS)  
· Working knowledge of networking concepts (DNS/DHCP/Firewalls/Sub-netting, etc.)

· Experience evaluating, designing, implementing, optimizing, and documenting a comprehensive and extensive array of Cloud security technologies and processes.

· Strong experience on common policy as code tools including Puppet, Chef, Open Policy Agent, and more

· Good knowledge for some of the languages: C, C# or other object-oriented languages, Go Lang, Python, Perl, Ruby, JavaScript, shell script, Powershell etc.  
· Experience in CI/CD pipeline and related open-source tools like GIT/Jenkin/CircleCI/SonarQube

· Expert in designing and implementing Infrastructure as Code (IaC) solutions to manage Cloud resources using Terraform  
...
· Expertise in Azure Functions, Azure Web Apps, and AWS Lambda  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-engineer-iaas-hybrid-cloud-remote)

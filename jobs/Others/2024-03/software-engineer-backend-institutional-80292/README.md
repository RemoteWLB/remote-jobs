# [Software Engineer, Backend - Institutional](https://www.remotewlb.com/apply/software-engineer-backend-institutional-80292)  
### Coinbase  
#### `💰 ~165k` `🌎 Remote,US`  
...
The Institutional Financing Product Group engineers create and maintain a suite of products catering to institutional customers of all sizes from Hedge Funds (Coinbase Prime) to experienced individual traders (Coinbase Advanced Trade) and everything in between. We build innovative financing products such as bilateral lending, trade financing, portfolio margin, etc. to bring capital efficiency to the institutional customers.

**What you'll be doing:**

  * Build platforms & services to serve Coinbase new, greenfield 0 to 1 financing platform using Golang, React and AWS services.
...
**Nice to haves:**
  ...
  * You have experience with microservices and service oriented architecture.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-backend-institutional-80292)

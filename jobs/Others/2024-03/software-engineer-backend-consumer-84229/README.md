# [Software Engineer, Backend - Consumer](https://www.remotewlb.com/apply/software-engineer-backend-consumer-84229)  
### Coinbase  
...
The Crypto Advocacy team is focused on building tools to engage Coinbase users and the broader crypto community in order to influence the public policy narrative and get pro-crypto regulations and laws passed. Mobilizing the crypto community is the single most effective way to influence lawmakers and get them to create and pass laws that will ultimately benefit the community and help grow Coinbase’s business. The Legislative action portal built by the team saw massive engagement giving a chance to the crypto community to engage directly with the lawmakers. The engineering team working in close collaboration with the Policy team has an ambitious roadmap with the goal of onboarding a million crypto advocates. This will be achieved by building a number of on-chain and off-chain apps in the ecosystem to engage the crypto community.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-backend-consumer-84229)

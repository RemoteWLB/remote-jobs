# [Senior Software Engineer, Growth (Hybrid)](https://www.remotewlb.com/apply/senior-software-engineer-growth-hybrid)  
### Homebase  
#### `🌎 Mexico`  
 ...
 **As a Homie, you are a bar raiser, this means you come with:**
  ...
  * Formidable Unit testing experience (with RSpec a plus)
  * Best practices handling integrations with 3rd party vendors (error handling, API Interface development)
  * Amplitude Experience a plus
...
As a Senior Software Engineer, you will design and implement software solutions that enhance the value of the Homebase software platform and impact the lives of our customers. You will play a prominent technical role in our engineering practice.
  ...
  * Your task will be to build a variety of web software applications and advance our existing software architecture, as well as continue to extend our existing APIs
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-growth-hybrid)

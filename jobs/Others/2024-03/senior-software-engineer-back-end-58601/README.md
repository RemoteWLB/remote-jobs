# [Senior Software Engineer (Back End)](https://www.remotewlb.com/apply/senior-software-engineer-back-end-58601)  
### Springhealth  
#### `💰 target salary range $159,100 - $194,150` `🌎 USA`  
...
We are looking for a Senior Backend Engineer to join our Caregiver Experience Organization. The team is responsible for the application used by all of Spring Health’s providers and is foundational to Spring Health. You will be an important thought leader in creating a great experience for our providers, you will help to define our product and engineering roadmaps, and you will work as part of a cross-functional product team to find elegant solutions to mental healthcare’s many problems. Additionally, you will guide the growth of the engineering team as a senior member.

**What You’ll be Doing:**

  * **Backend Development:** Leverage your experience with Ruby on Rails to refactor and optimize our core scheduling paths, ensuring scalability and maintainability.
  ...
  * **Product Collaboration:** Work closely with product managers and designers to develop exceptional user experiences, with a specific focus on delivering value to our provider network. **  
...
![](https://remotive.com/job/track/1899034/blank.gif?source=public_api)  
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-back-end-58601)

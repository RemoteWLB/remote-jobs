# [Software Engineer II](https://www.remotewlb.com/apply/software-engineer-ii-78075)  
### Homebase  
#### `🌎 Mexico`  
 ...
 **As a Growth Hacker, you are a bar raiser, which means you come with**

  * 3+ years of Web Software Engineering experience
  * 2+ years of experience in MVC software framework: Ruby and Rails 
  * Unit testing experience (with RSpec a plus)
  * Knowledge on handling integrations with 3rd party vendors (error handling, API Interface development)
  * Solid understanding of object-oriented software design and design patterns
  * Firm understanding of SQL and data modeling for scalability and performance
  * Familiarity with Marketing Analytics (ex: Google Analytics 4, Google tag manager, or comparables)
  * Not a stranger to lifecycle tooling (ex: Iterable, Twilio, or comparables)
...
As a Software Engineer in Growth, you will play a crucial role in driving the evolution of our product by experimenting, iterating, and implementing growth strategies. The ideal candidate is comfortable with ambiguity and failure, thrives in a fast-paced environment, and possesses a genuine passion for creating impactful solutions. If you are a risk-taking, scrappy, and unconstrained thinker who takes pride in ownership, we want you on our team.

  * Collaborate with cross-functional teams to identify growth opportunities and implement strategies to drive user acquisition
  * Rapidly prototype and iterate on ideas to validate assumptions and hypotheses
  * Take ownership of growth experiments, measure key metrics, and examine results to inform decision-making with your partners
...
### What to Expect During the Interview Process:
  ...
  * Meet the Hiring Manager Jatin B. 
  * Meet the Leadership team Steve K.
  * Participate in a Technical Interview
  * Meet with the Growth Team Candy L. and Alvin D. 
  * Meet with the VP of Product Engineering Alamelu R.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-ii-78075)

# [Staff Software Engineer, Frontend - Institutional](https://www.remotewlb.com/apply/staff-software-engineer-frontend-institutional)  
### Coinbase  
#### `🌎 Remote - Canada`  
...
The Institutional Product Group engineers create and maintain a suite of products catering to institutional customers of all sizes from Hedge Funds (Coinbase Prime) to experienced individual traders (Coinbase Advanced Trade) and everything in between. Additional Products include Prime - Custody Only, Commerce and Exchange. Whether the customer needs are trading, staking, governance, custody or API integrations, Coinbase Institutional has them covered.

**What you’ll be doing:**

  * Architect and developa mass market interface for digital currency apps by adding new functionality to existing cryptocurrencies (i.e. staking, voting, predicting).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-engineer-frontend-institutional)

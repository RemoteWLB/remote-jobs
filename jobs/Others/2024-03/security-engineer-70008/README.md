# [Security Engineer](https://www.remotewlb.com/apply/security-engineer-70008)  
### Coinbase  
#### `💰 321900.0` `🌎 United States`  
...
As a Software Engineer in Security Engineering, you will be working on building capabilities and solutions for a variety of security use cases. Our team builds and maintains the platforms critical for security, compliance and privacy at Coinbase. You will be working on designing novel services & solutions for blockchain monitoring, dApps monitoring, capabilities to blocklist malicious addresses and verifying integrity of transactions before they are broadcasted on chain.
 ...
 **What you’ll be doing (ie. job duties):** **To be completed by all business teams except Eng.**
  ...
  * Build new services to meet critical product and business needs using Python, Golang.
 ...
 **What we look for in you (ie. job requirements):** **To be completed by all business teams except Eng.**
  ...
  * You’re passionate about building an open financial sytem that brings the world together.
 ...
 **Pay Transparency Notice:** Depending on your work location, the target annual salary for this position can range as detailed below. Full time offers from Coinbase also include target bonus + target equity + benefits (including medical, dental, vision and 401(k)).Pay Range: $147,900—$174,000 USD
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/security-engineer-70008)

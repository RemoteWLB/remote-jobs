# [Security Operations Center Engineer](https://www.remotewlb.com/apply/security-operations-center-engineer-78971)  
### Cloudflare  
#### `💰 259000.0` `🌎 United States`  
...
Security Operations Center Engineers analyze threats, make detailed and informed suggestions for mitigation and may need to implement mitigation strategies directly on behalf of the customer. The team also provides attack reporting beyond Cloudflare’s self-service reports.
...
####  **Responsibilities**
  ...
  * Previous DDoS mitigation for OSI layers 3,4, 7 is a must: filter malicious traffic using Cloudflare tools like Magic Transit, Network Firewall, WAF, IP reputation lists, packet inspection, blacklisting, whitelisting, and/or rate limiting
...
### Key skill sets
  ...
  * Previous knowledge of Cloudflare Security Products Features
  * 4 years of technical support experience and customer support experience is a must
  * Strong communication skills with high-value customers under attack
  ...
  * Calm under pressure
  * Previous project management skills helpful.

### Compensation

Compensation may be adjusted depending on work location.

  * For Colorado-based hires: Estimated annual salary of $105,000 - $129,000
  * For New York City, Washington, and California (excluding Bay Area) based hires: Estimated annual salary of $118,000 - $144,000.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/security-operations-center-engineer-78971)

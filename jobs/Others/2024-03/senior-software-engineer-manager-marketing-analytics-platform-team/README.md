# [Senior Software Engineer Manager | Marketing Analytics Platform team](https://www.remotewlb.com/apply/senior-software-engineer-manager-marketing-analytics-platform-team)  
### Gympass  
#### `💰 ~0k` `🌎 Remote,Brazil`  
...
We are hiring a **Senior Software Engineer Manager** to our **Marketing Analytics Platform** team in **Brazil**!

MEP (Marketing Engineering & Platform) Focus Area is responsible for enabling and maximizing Marketing efforts through technology and product integrations. Our goal is uncover new growth opportunities through analyses; determine the best infrastructure and processes for growth. We work to Optimize traffic to B2B and B2C sign-up/purchase conversion with an experiment-first approach, fresh and engaging web content, funnel paths and personalization. We also work providing platform and integration by combining marketing and product data from different sources to create a unified and consistent view acting as enablers to fulfill Marketing to work with segmented pipelines.The Marketing Analytics Platform team is in charge of creating data products such as Customer Data Platform (CDP) and data pipelines focused on enabling Marketing campaigns, attribution model and analytics insights.  

# **YOUR IMPACT**

  * Developing a vision for Marketing Analytics Integration Ecosystem;
  * Drive architecture decisions that impact our whole Marketing analytics platform development interactions;
...
# **WHO YOU ARE**
  ...
  * Have expertise with at least two programming languages such as Java, Scala, Python, Ruby, JavaScript or Golang;
  * Extensive experience with SQL/NoSQL technology such as PostgreSQL, MySQL, DynamoDB understanding common use cases and performance pitfalls;
  ...
  * Is capable of understanding pitfalls and anticipating common failure modes of a microservice environment;
  ...
  * A strong communicator: able to communicate effectively with technical and nontechnical stakeholders in English and Portuguese;  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-manager-marketing-analytics-platform-team)

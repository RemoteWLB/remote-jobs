# [Senior Software Engineer, Reliability - Platform](https://www.remotewlb.com/apply/senior-software-engineer-reliability-platform-80195)  
### Coinbase  
#### `🌎 Remote - Canada`  
...
We are looking for an experienced **Senior Software Engineer** to join our Observability team. The Observability team sits within our Infrastructure organization. By joining this team, you'll be critical to helping us re-invent the observability stack at Coinbase as we continue to grow and scale 10X-100X.

The greater Infrastructure org supports the systems, services, and tooling at the foundation of Coinbase’s mission to increase economic freedom. We enable Coinbase engineers to design, develop, and operate services quickly, safely, securely and reliably. **** Infrastructure teams build and maintain the platforms critical to the existence of Coinbase.
...
**What we look for in you (ie. job requirements):**
  ...
  * You have experience working with containers / container orchestration systems (Docker, ECS, EKS, etc) andmonitoring tools (DataDog, Graphite, Grafana, and Prometheus)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-reliability-platform-80195)

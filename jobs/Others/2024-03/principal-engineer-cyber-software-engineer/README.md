# [Principal Engineer - Cyber Software Engineer](https://www.remotewlb.com/apply/principal-engineer-cyber-software-engineer)  
### GEICO  
#### `💰 ~261k` `🌎 US,Remote`  

Description

**GEICO** is seeking an experienced **Principal Engineer** with a passion for building high performance, enterprise security capabilities and applications. You will help drive our insurance business transformation and security engineering domain modernization as we redefine secure experiences for our customers.  
...
As a Principal Engineer, you will:
  ...
  * Understand open-source security products similar to Security Onion, Snort, Osquery, IDS/IPS, OpenVAS, Defect Dojo, Zabbbix, Grafana, CloudSploit, Suricata etc.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/principal-engineer-cyber-software-engineer)

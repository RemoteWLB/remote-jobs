# [PHP Developer](https://www.remotewlb.com/apply/php-developer-134034)  
###  
#### `🌎 remote,APAC`  
...
* 参与相关需求分析、技术设计及产品研发工作，编写高质量代码，及时交付产品；
* 负责撰写相关开发文档；
* 维护相关业务系统或模块，及时解决Bug和故障，保障系统运行稳定；
* 负责保障系统安全，及时修复系统安全问题。
...
* 本科及以上学历，计算机或相关专业；
* 5年以上PHP开发经验，有golang开发经验者优先；
* 精通主流PHP开发框架Laravel、ThinkPHP、Yii等，熟悉Swoole, Hyperf框架优先；
* 软件知识结构全面，基础扎实，熟悉常用数据结构与算法，熟悉面向对象编程；
* 熟悉Mysql数据库，能够快速根据需求完成高性能数据库设计；
* 熟悉Redis，了解Redis常用数据结构优缺点和使用场景；
* 熟悉Kafka、RocketMQ、RabbitMQ等常见消息队列的使用；
* 高度的责任心、良好的沟通理解能力和团队合作精神，正直进取，有上进心，热爱开发事业。
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/php-developer-134034)

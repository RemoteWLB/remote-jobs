# [Senior Software Engineer, API Gateway - Europe (Remote)](https://www.remotewlb.com/apply/senior-software-engineer-api-gateway-europe-remote)  
### Kong  
#### `🌎 remote,EMEA`  
...
* Work closely with engineering teams to architecture, design, and understand upcoming new features.
...
* Experience programming low-level networking systems: Nginx and/or Openresty are preferred but others like Apache are also valid
* Experience in any of the following: IdP/AuthZ systems and integration, monitoring and profiling systems, network traffic inspection.
* Optional, but highly sought after: At least 2 years of experience working with Rust
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-api-gateway-europe-remote)

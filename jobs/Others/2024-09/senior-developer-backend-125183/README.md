# [Senior Developer (Backend)](https://www.remotewlb.com/apply/senior-developer-backend-125183)  
### 1Password  
...
We’re hiring **Senior Developers** across 1Password Tech teams.

  

**Programmatic Interfaces:**

Our team focuses on enabling partners, the developer community and customers to build and integrate with 1Password. We build and maintain the APIs, authentication and SDKs that enable them, along with a couple integrations of our own, including integrations for CI/CD, Kubernetes and Terraform.
...
* We currently use MySQL (Aurora), Kafka, Redis, Kubernetes and Golang for our backend services and are transitioning from a monolithic to a service oriented architecture.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-developer-backend-125183)

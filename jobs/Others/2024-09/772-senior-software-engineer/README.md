# [(772) Senior Software Engineer](https://www.remotewlb.com/apply/772-senior-software-engineer)  
### Nearsure  
...
We are seeking an experienced **Senior Java Engineer** to join our talented engineering team. You will help ensure code is well-written and architected according to best practices for performance, scalability, reliability, and usability.

**You will be able to:**

  * Be a hands-on, contributing developer on your team.

  * Create and/or operate an automated build pipeline that includes compilation and unit testing.

  * Monitor escalation channels, investigate the issues.

  * Work on issue resolution processes from root cause analysis to solution scenario ideation and validation.
...
**What will help you succeed in this role:**
  ...
  * 5+ Years of experience working with Spring.

  * 5+ Years of experience working with SQL.

  * 4+ Years of experience working with Automation Testing.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/772-senior-software-engineer)

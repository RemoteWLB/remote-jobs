# [Senior Backend Engineer (non-elixir)](https://www.remotewlb.com/apply/senior-backend-engineer-non-elixir)  
### Remote  
#### `🌎 Remote-UK&I`  
...
**Must have (professional experience):**
  ...
  * Significant experience as a Backend Engineer working with functional programming languages, which includes building, shipping and maintaining a complicated software project
  * Postgres (or similar)
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-backend-engineer-non-elixir)

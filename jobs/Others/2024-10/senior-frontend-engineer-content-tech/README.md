# [Senior Frontend Engineer (Content Tech)](https://www.remotewlb.com/apply/senior-frontend-engineer-content-tech)  
### Binance  
#### `🌎 remote,Asia`  
...
* Implement new user-facing features in Binance’s Square features which is a huge social community.
* Write client-side code to create super-fast, easy-to-use, web-based applications which include website for both MP(mini-progoram) and PC browsers, and hybrid in-app pages.
...
* 3-5+ years developing production JavaScript code and strong knowledge of VUE/React.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-frontend-engineer-content-tech)

# [Java Backend Developer - Web3 Wallet](https://www.remotewlb.com/apply/java-backend-developer-web3-wallet)  
### Binance  
#### `🌎 remote,Asia`  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/java-backend-developer-web3-wallet)

# [Software Engineer II](https://www.remotewlb.com/apply/software-engineer-ii-131523)  
### Pathward, N.A.  
#### `🌎 Remote`  
...
**What You Will Need:**
  ...
  * Experience with the following technologies is expected, but not all are required: General knowledge of .NET, C#, ASP.NET, MVC, Entity Framework, JavaScript, HTML, CSS, XML/XSLT.
  * Experience with the following technologies is preferred: Angular/AngularJS, AWS, NServiceBus, PowerBI.
  * Experience practicing SOLID design principles in Object-Oriented Programming.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-ii-131523)

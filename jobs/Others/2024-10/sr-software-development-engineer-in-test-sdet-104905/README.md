# [Sr Software Development Engineer in Test - SDET](https://www.remotewlb.com/apply/sr-software-development-engineer-in-test-sdet-104905)  
### BeyondTrust  
#### `🌎 Remote United States (EST) | Remote Canada (EST/AST)`  
...
BeyondTrust is seeking a Senior Software Development Engineer in Test with a passion for developing robust software and an interest in leveraging test automation to enhance software quality. This role presents a distinctive chance to take the lead in overcoming cloud-scale challenges, shaping the way we build, test, and deliver a platform that will support many applications, including a pioneering ITDR system, with top-notch reliability and performance.

_What You’ll Do_

  * Develop and maintain critical features for enterprise-scale platform while ensuring quality and stability through test automation.
...
_What You’ll Bring_
  ...
  * Proficiency in programming with **Python and JavaScript** , or a similar level language, coupled with an understanding of QA methodology and tools from a development perspective.
  * Working knowledge of CI/CD workflows such as GitHub Actions
  * Experience with BDD such as Cucumber, Gherkin and Cypress.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/sr-software-development-engineer-in-test-sdet-104905)

# [Developer Intern - XAM - Winter 2025](https://www.remotewlb.com/apply/developer-intern-xam-winter-2025)  
### 1Password  
#### `🌎 remote,Canada`  
...
This is an exciting and dynamic opportunity to be at the center of a new multi-year strategic initiative for the company.
...
This is a remote opportunity within Canada. **This is a full time (40 hours per week) position that will run for 4 months - January to April 2025.**
...
* Write efficient, scalable, and robust customer-facing features in one or more of our web (Typescript and Golang) and client (iOS, Android, or Rust) tech stacks.
...
* Take a full stack approach to development by navigating everything from databases up to the frontend UI.
...
* Front end web development experience with modern javascript frameworks like React, Angular, or Vue.js. We also use a lot of TypeScript.
* Front end iOS development experience in Swift using SwiftUI and UIKit.
* Front end Android development experience in Kotlin using Jetpack Compose and the Android view framework.
* Back end experience with Rust
 ...
 **This role will close on Friday, October 11, 2024.**
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/developer-intern-xam-winter-2025)

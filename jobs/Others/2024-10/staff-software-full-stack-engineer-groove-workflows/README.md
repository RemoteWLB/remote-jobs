# [Staff Software Full Stack Engineer, Groove Workflows](https://www.remotewlb.com/apply/staff-software-full-stack-engineer-groove-workflows)  
### Clari  
#### `💰 $180,000 - $270,000` `🌎 remote,Remote, San Francisco Bay Area`  
...
We're looking for well-rounded engineers who want to take on big projects, collaborate closely with others, grow a lot, and help shape the future of the company. You will have a direct influence on product and technology solutions and help define our culture as we change how companies and teams sell.
...
* 8+ years frontend development using JavaScript, TypeScript and React
* 5+ years of professional experience in software development using frameworks such as Ruby on Rails, Python, Node.js or similar
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-full-stack-engineer-groove-workflows)

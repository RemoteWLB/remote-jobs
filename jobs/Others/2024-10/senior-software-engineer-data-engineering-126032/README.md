# [Senior Software Engineer, Data Engineering](https://www.remotewlb.com/apply/senior-software-engineer-data-engineering-126032)  
### Lime  
#### `🌎 remote,Canada`  
...
The Data Engineering team at Lime is responsible for ingesting, transforming and making available timely, high-quality data that powers analytics, bookkeeping and visibility for a wide range of customers.
...
* Identify, define, and solve strategically essential technical problems, including architecting and building highly scalable foundational platforms, leading new product initiatives, and revamping existing core application experiences.
* Mentor and lead other engineers at Lime. Identify and develop future leaders.
* Enforce controls across pipelines to ensure incredibly high accuracy for all financial transactions (hundreds of millions of dollars). 
* Work in a collaborative environment involving different stakeholders and subject matter experts across Finance, Operations, Strategy, Data Science and Product.
* Assist in preparing data-related documentation for SEC filings and due diligence processes
* Implement data governance policies and ensure data security and compliance
...
* Experience in a pre-IPO or public company environment is a plus

  

The anticipated salary range for this position is CA$126,000 - CA$174,000. Annual performance bonus, equity and benefits may be provided as part of the compensation package, depending on the position offered. Not all candidates will be eligible for the upper end of the salary range. Exact salary will ultimately depend on multiple factors, which may include the candidate’s location of residence, the successful candidate's skills, experience and other qualifications. In addition to base salary, some roles may be eligible for a variable performance-bonus based on a combination of company performance, employee performance, and management discretion.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-data-engineering-126032)

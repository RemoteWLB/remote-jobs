# [Lead Software Engineer | GenAI](https://www.remotewlb.com/apply/lead-software-engineer-genai-127424)  
### Wellhub  
#### `🌎 Portugal (Remote)`  
...
We are hiring a **Lead Software Engineer** for our **GenAI team** in **Portugal**!
...
We are looking for a passionate and skilled Lead Software Engineer to join our team and help us build the next generation of AI-powered solutions. This role focuses on generative AI, Retrieval-Augmented Generation (RAG) + LLMs fine tuning, and API integrations. **Talented lead software engineers of any area who would like to shift their career to invest in AI are welcome to apply if they are a match to some of the qualifications and preferred qualifications listed below. Such candidates must be avid learners and be prepared to learn fast.**

# **YOUR IMPACT**

You will be working on one or more of the following exciting areas:
...
# **WHO YOU ARE**
  ...
  * Keen on helping your team to collaborate within and with other teams;
  * Lead by example and seen by others as an inspiring technical leader.
...
The following are preferred qualifications:  
  ...
  * Proven experience with one or more topics listed in the Responsibilities section.
  * Familiarity with large language models, generative AI frameworks (e.g., Haystack, Langchain, LlamaIndex, HuggingFace, Ollama, AWS Bedrock).
  * Knowledge of retrieval-augmented generation (RAG) and related technologies.
  * Experience with cloud platforms (e.g., AWS, GCP, Azure).
  * Knowledge of data engineering and ETL processes (e.g., Spark, Flink).
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/lead-software-engineer-genai-127424)

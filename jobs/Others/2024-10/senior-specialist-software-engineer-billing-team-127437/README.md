# [Senior Specialist Software Engineer | Billing Team](https://www.remotewlb.com/apply/senior-specialist-software-engineer-billing-team-127437)  
### Wellhub  
#### `🌎 Portugal (Remote)`  
...
We are hiring a **Senior Specialist Backed Engineer** for our **Billing** team in Portugal!

Responsible for the platform that serves the entire Wellhub business, processing millions of transactions for users and companies around the globe.

Our architecture and its set of systems guarantee consistency across multiple areas and services to calculate users' and clients' subscription prices, covering the whole complexity of Wellhub's business.
...
# **WHO YOU ARE**
  ...
  * You are a professional that focus on making things right and better at every opportunity
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-specialist-software-engineer-billing-team-127437)

# [Senior Backend Engineer (Node.js/AWS/K8s) - Infra Engineering](https://www.remotewlb.com/apply/senior-backend-engineer-node-js-aws-k8s-infra-engineering)  
### None  
#### `🌎 Brazil`  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-backend-engineer-node-js-aws-k8s-infra-engineering)

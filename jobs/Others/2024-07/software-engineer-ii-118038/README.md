# [Software Engineer II](https://www.remotewlb.com/apply/software-engineer-ii-118038)  
### Spring Health  
#### `💰 $120,000 - $150,250` `🌎 Remote`  

We are looking for a Full Stack Engineer to join our team. You will help to define our product and engineering roadmaps and work as a part of a cross-functional product team to find elegant solutions to mental healthcare’s many problems.
...
**What success looks like in this role:**
  ...
  * **Ensuring System Quality** : Maintain high system uptime, low defect rates, and provide strong code review feedback.
  * **Optimizing Engineering Efficiency** : Achieve high completion rates for planned tasks, and increase deployment frequency.
  * **Successful Project Delivery** : Deliver projects on time, within scope, and with high stakeholder satisfaction.
  * **Effective Cross-functional Collaboration** : Receive positive feedback from partners, participate actively in meetings, and align on project goals.
  * **Independent Work Proficiency** : Complete tasks independently, resolve issues before escalating, and track personal tasks accurately.
  * **Iterative Learning and Experimentation** : Maintain a high success rate for experiments, implement improvements, and share learnings.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-ii-118038)

# [Senior Software Engineer II](https://www.remotewlb.com/apply/senior-software-engineer-ii-116240)  
### Affinity.co  
#### `🌎 Canada (Remote)`  
...
As a **Senior Software Engineer II** on the **CRM Team** , you’ll have the opportunity to evolve the implementation of the spreadsheet-like interfaces that are core to how our users manage and view their data in the application. This is a particularly complex domain because the data modeling needs to be extremely flexible to support unique use cases. You’ll also guide the future of the new automations offering, which enables configuring workflows to manipulate data using if-this-then-that rules.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-ii-116240)

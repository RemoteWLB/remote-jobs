# [Senior Fullstack Engineer (m/f/x) onsite or remote (in Germany)](https://www.remotewlb.com/apply/senior-fullstack-engineer-m-f-x-onsite-or-remote-in-germany)  
### Scalable GmbH  
#### `🌎 Germany`  
...
### Qualifications
  ...
  * Strong programming skills in Java, Javascript, Vue.js, Python
  * Knowledge in Apache Wicket and Velocity is an advantage
  * Skills in HTML, CSS, SCSS
  * Experience in integrating external APIs, e.g. data, payment
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-fullstack-engineer-m-f-x-onsite-or-remote-in-germany)

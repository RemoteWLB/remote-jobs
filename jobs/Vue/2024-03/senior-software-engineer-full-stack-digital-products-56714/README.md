# [Senior Software Engineer, Full Stack (Digital Products)](https://www.remotewlb.com/apply/senior-software-engineer-full-stack-digital-products-56714)  
### Scout Motors  
...
As the Sr Software Engineer for Scout Motor’s digital products, you will play a key role in the development and enhancement of our software products, from concept to deployment. You will work closely with cross-functional teams to design, develop, and implement scalable and robust solutions that meet our customers' needs and exceed their expectations. Some of the key products as part of digital portfolio are – order management, customer management, marketing, production, inventory and planning optimization, loyalty, merchandise, servicing and repairs, mobile app, vehicle connectivity, and more. You will work with engineering managers, staff engineers, and cross-functional partners to design the technical underpinnings of the product.
  ...
  * Develop high-quality, maintainable code across the full stack, including front-end, back-end, and database layers.
...
Location & Travel Expectations: The responsibilities of this role require attendance at in-person meetings and events occasionally. The role will be based out of a Scout Motors location in Fremont, CA _or_ Remote. Applicants should expect that the role will require the ability to convene with Scout colleagues in person and travel to participate in events on behalf of the company.
...
We expect all Scouts to have integrity, curiosity, resourcefulness, and strive to exhibit a positive attitude, as well as a growth mindset. You’ll be comfortable with change and flexible in a fast-paced, high-growth environment. You’ll take a collaborative approach to achieve ambitious goals.
  ...
  * Proficiency in the front-end technologies (e.g., HTML, CSS, JavaScript, React, Angular, Vue.js) and back-end technologies (e.g., Go, Node.js, Python, Java, Ruby).
...
### Preferred Qualifications:
  ...
  * Hands on experience building on AWS using React, Angular, Go and/or Python.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-software-engineer-full-stack-digital-products-56714)

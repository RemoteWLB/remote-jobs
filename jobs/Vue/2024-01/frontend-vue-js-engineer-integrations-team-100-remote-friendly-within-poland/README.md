# [Frontend Vue.js Engineer, Integrations Team (100% remote-friendly within Poland)](https://www.remotewlb.com/apply/frontend-vue-js-engineer-integrations-team-100-remote-friendly-within-poland)  
### Docplanner  
#### `💰 65k-95k USD` `🌎 Poland`  
...
As a **Frontend Engineer** , you will become a valuable member of the Integrations Team within our Integrations business domain. Your responsibilities will encompass both the design and implementation of solutions while adhering to and promoting best practices in software analysis, design, and development.

As an Integrations Team, we focus on building APIs that our partners use to integrate with our healthcare products. We also create embeddable widgets that Clinics and Doctors use to boost their efficiency and experience without leaving the software of their choice. In this business domain, you will collaborate with fellow engineers who are experts in Vue.js, Electron, .NET, and PHP.

Each team in the domain benefits from the guidance of a dedicated Product Manager and Team Leader. We employ modern product discovery techniques inspired by the works of Marty Cagan and Teresa Torres. Regarding workflow, we adopt the Shape Up methodology and empower our engineering teams with high autonomy. The current team size stands at eight members.

 **In this role, your primary focus will be on the frontend applications, which are developed using Vue.js, Webpack Module Federation and our custom UI Kit.**
...
### You’re a great fit for this role if:
  ...
  * You are aesthetically sensitive and have attention to detail.
  * You are a great team player!

### What will help you thrive?

  * Have more than 2 years of experience working on web applications.
  * You work with JavaScript ES6, TypeScript, and you know Vue 3. 
  * You work with tools such as GIT, SASS, Yarn 3, Webpack, Vite, esbuild, NPM daily.
  * You have practical knowledge of designing the frontend architecture.
  * You are used to working in an Agile, high-autonomy environment. We work in Shape Up!
...
### Bonus points
  ...
  * You have experience building systems made of multiple frontend applications or microfrontends.
  * You have experience working with Webpack Module Federation.
  * You have experience ensuring security of frontend applications and authentication flows. 
  * You have .NET, PHP or any other backend experience.
  * You have experience working with Docker.
  * You have experience designing APIs.
  * You have experience working with UI Kit / Design System.
...
For B2B contract: between 14 000 and 17 000 PLN net monthly  
 _Or company cost equivalent on employment contract_  
 _The range is broad so that we can accommodate our roles for all levels of experience, but we will show you the career ladder to explain where we see your skills and impact within the company. Your salary will be, now and always, 100% transparent to you;_

...
À titre de Développeur•euse Logiciel Senior, vous serez un membre clé de notre équipe Plexia d’architecture logicielle. Vous participerez à l’architecture, la conception, l’implémentation et le déploiement de nouvelles fonctionnalités logicielles développées par nos équipes produit pour enrichir l’écosystème Plexia, un produit qui cherche à changer le milieu des soins de santé en proposant de nouvelles pratiques et innovations technologiques.
 ...
 **Atouts**
  ...
  * Connaissance du domaine d’affaires de l'industrie des soins de santé; et connaissance de HL7 FHIR, HL7 Smart sur FHIR, OAUTH2 et OpenConnect ID

  * L'expérience en développement ASP.NET WebForms est un atout car vous serez en charge du produit Plexia et des fonctionnalités qui sont fortement développées avec ASP.NET WebForms.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/developpeur-euse-logiciel-senior-105312)

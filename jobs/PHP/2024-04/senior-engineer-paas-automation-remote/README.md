# [Senior Engineer – Paas Automation Remote](https://www.remotewlb.com/apply/senior-engineer-paas-automation-remote)  
### GEICO  
#### `💰 USD 76k~236k` `🌎 US,Remote`  
...
**Qualifications**
  ...
  * Proficient in automation and configuration management using Ansible, with a strong understanding of Ansible playbooks, roles, and inventory management

  * Hands-on experience with Ansible AWX (the open-source version of Ansible Tower), including setting up AWX projects, templates, and workflows for automating and orchestrating complex deployment and operational tasks
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-engineer-paas-automation-remote)

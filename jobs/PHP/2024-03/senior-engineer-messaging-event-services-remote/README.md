# [Senior Engineer – Messaging & Event Services (REMOTE)](https://www.remotewlb.com/apply/senior-engineer-messaging-event-services-remote)  
### GEICO  
#### `💰 ~185k` `🌎 US,Remote`  

Description

GEICO's **Platform as a Service** organization is seeking an experienced Senior Engineer with a passion for building high performance, low maintenance, zero-downtime platforms, and applications to focus on our **Messaging & Event Services** solutions. You will help drive our insurance business transformation as we transition from a traditional IT model to a tech organization with engineering excellence as its mission, while co-creating the culture of psychological safety and continuous improvement.

Our Senior Engineer works with Distinguished and Principal Engineers to innovate and build new systems, improve and enhance existing systems as well as identify new opportunities to solve critical problems. You will execute a technical roadmap that will increase the velocity of delivering products and unlock new engineering capabilities.

The ideal candidate has proven, technical experience in the open-source messaging and event streaming domain.  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/senior-engineer-messaging-event-services-remote)

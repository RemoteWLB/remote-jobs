# [PHP Developer, Medical Records Team (100% remote-friendly within Poland)](https://www.remotewlb.com/apply/php-developer-medical-records-team-100-remote-friendly-within-poland)  
### Docplanner  
#### `💰 414000.0` `🌎 Poland`  
...
### Info about the team:
  ...
  * The goal of the medical records team is to make the medical data, coming from doctors, accessible to the patient. This includes:
    * Present the documentation in a clear, manageable, and reusable way.
    * Allow the caregivers to manage the the medical information of their family, 
    * Make this information available on mobile and desktop devices.
  * Team team composition: 3 PHP Developers, 2 .NET Developers, 3 Frontend & Mobile Developers, Team Lead, Product Manager, Content Designer, Product Designer, and Business Analyst… and we're waiting for you :) 
  * We are currently working on integrating medical data from different sources.

### How would you be impacting our mission?

  * Your role in backend development will be key in creating a more accessible and useful platform for patients.
  * You will directly contribute to the company's mission of empowering patients with valuable and accurate information.
  * Tackle complex technical problems and optimize backend performance.
  * You would have the opportunity to work on new technologies and systems. Creating huge impact to the company.
...
### What will help you thrive?
  ...
  * You have practical experience in designing the backend architecture and APIs.
  ...
  * Growth mindset: nobody ticks all the boxes above, but a willingness to learn is highly valued here.
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/php-developer-medical-records-team-100-remote-friendly-within-poland)

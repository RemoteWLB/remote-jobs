# [Software Engineer, L3](https://www.remotewlb.com/apply/software-engineer-l3-80313)  
### Twilio  
#### `🌎 Colombia`  

### **See yourself at Twilio**

Join the team as Twilio’s next Software Engineer, L3 - Phone Numbers.
...
As a Software Engineer, L3, you'll be playing a pivotal role in designing, building, and deploying the next generation of our distributed systems and microservices architecture. You will work closely with Product and Design and be responsible for building low latency, highly scalable APIs.

We're looking for a backend engineer to join us as we begin the next stage of Phone Numbers at Twilio, pushing forward the entire industry in the process
...
### In this role, you’ll:
  ...
  *  **Modernizing Software** : Collaborate and contribute to the migration and optimization of our tech stack to leverage the modern technologies, ensuring future-proof scalability and agility while maintaining backward compatibility. 
...
### Required:
  ...
  * 5+ years of experience with a proven track record of designing, building, and deploying large, scalable distributed systems and microservices architectures. Expert in utilizing asynchronous communication patterns like Kafka or similar tools to achieve optimal performance and decoupling.
  * 4+ years of experience in Java, including advanced concepts like concurrency, threading, and performance optimization. 
  * 3+ years of experience with a strong understanding of relational databases like MySQL, including query optimization and data modeling principles.
  ...
  * Experience with mentoring junior experience 
...
### Desired:
  ...
  * Experience with containerization technologies like Docker and Kubernetes for microservices deployment and management.

### Location

This role will be based in our Remote - Colombia
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/software-engineer-l3-80313)

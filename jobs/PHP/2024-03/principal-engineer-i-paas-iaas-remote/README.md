# [Principal Engineer I – PaaS_IaaS (REMOTE)](https://www.remotewlb.com/apply/principal-engineer-i-paas-iaas-remote)  
### GEICO  
#### `💰 ~204k` `🌎 Frederick, MD,US,Remote`  
...
• Understand open-source databases like MySQL, PostgreSQL, etc, familiar with No-SQL databases like Cassandra, MongoDB, Elasticsearch; knowledge with NewSQL database like TIDB, Cockroach or YugabyteDB will be a plus  
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/principal-engineer-i-paas-iaas-remote)

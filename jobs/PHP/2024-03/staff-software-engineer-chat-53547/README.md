# [Staff Software Engineer, Chat](https://www.remotewlb.com/apply/staff-software-engineer-chat-53547)  
### Replicant  
...
Are you ready to make your mark on the future of Conversational AI? Here at Replicant, we're not just creating technology; we're pioneering an industry. We're seeking a high-impact Senior Engineer for the Platform team to accelerate the transformation of our state-of-the-art virtual call center platform.  
At this moment, our team has a special and unusual opportunity to revisit fundamental architectural decisions and set us up for 20x scaling and growth. The platform is the kernel of our product and our business. We integrate telephony, speech-to-text, LLM and ML services, speech-to-text, and analytics, all in real-time with minimal latency. And you can help us solve the big, hard, interesting problems to set up our platform for massive growth.  
...
### What you'll do
  ...
  * Develop and maintain large-scale, multi-tenant backend services in TypeScript
  * Provide technical leadership and thorough review of code
  * Share your passion for learning about technical topics with your team and peers
  * Collaborate with your team in a rigorous yet lightweight agile process
  * Participate in regular on-call rotations to support our production systems

### What you'll bring

  * 5+ years of software development experience in a SaaS environment (Depending on level)
  * Experience with some of our primary technologies: TypeScript (or similar), Node.js, Kubernetes, PostgreSQL, and GCP
  * Strong experience in object-oriented programming, test-driven development, distributed systems, and API design
  * Independent thinking and relish of tackling thorny technical challenges
  * Experience mentoring junior software engineers
  * Passion for participating in a fun, collaborative, productive team culture
...
## CLICK TO [APPLY](https://www.remotewlb.com/apply/staff-software-engineer-chat-53547)
